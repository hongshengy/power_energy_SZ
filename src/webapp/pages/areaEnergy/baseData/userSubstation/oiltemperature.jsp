        ...
        $(document).ready(function(){
		 ...
		 function loadQydlBar(){
		 	...
		 	queryparam = "queryPara.DEVICE_ID="+device+"&queryPara.DATE_TIME="+data
		  	+"&queryPara.ORG_NO=02&queryPara.TYPE=TP&queryPara.startSize="+station;
			document.getElementById("jcxtpFrame").src = basePath+"pages/areaEnergy/baseData/userSubstation/oilpic.jsp?device="+device+"&data="+data+"&type=TP&station="+station;
	 	 	document.getElementById("jcxsjFrame").src = basePath+"/userDataCenterAction/reflowProfileData.action?"+queryparam;
		 }
