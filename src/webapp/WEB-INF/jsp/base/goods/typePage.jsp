...
<div class="panel-body" style="padding-bottom:5px;">
    <div class="panel panel-default" id="showPanel">
        <div class="panel-heading">添加物资类型</div>
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                <div class="form-group" style="margin-top:15px">

                    <label class="control-label col-sm-1 text-nowrap" for="goods_Type_Name">物资类型名</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="goods_Type_Name" name="goods_Type_Name">
                    </div>

                    <label class="control-label col-sm-1 text-nowrap" for="goods_Type_Code">物资类型CODE</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="goods_Type_Code" name="goods_Type_Code">
                    </div>

                    <label class="control-label col-sm-1 text-nowrap" for="goods_Type_Content">物资类型描述</label>
                    <div class="col-sm-3">
                ...
                <div class="form-group" style="margin-top:15px">
                    ...
                    <label class="control-label col-sm-1 text-nowrap" for="goods_Type_Status">物资类型状态</label>
                    <div class="col-sm-3">
                        <div id="goods_Type_Status"></div>
                    </div>

                    <label class="control-label col-sm-1 text-nowrap" for="goods_Type_Remark">物资类型备注</label>
                    <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    //        发起layer询问框
        layerConfirm('确认提交？', ['确认', '取消'], [function () {                                                //**************
            ...
            getDataFnNoErrorF(                                                                                  //**************
                insertDataPath                                                                                  //**************
                , $('#formSearch').serialize() + '&sql=GoodsTypeMapper.insertInfo'                              //**************
                , function (data) {                                                                             //**************
                    if (null != data) {                                                                         //**************
                        parent.query(1, 10);                                                                    //**************
                        parent.layer.closeAll();                                                                //**************
