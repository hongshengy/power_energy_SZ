                ...
                <div class="panel-body">
                    <form id="formSearch" class="form-horizontal">
                        <div class="form-group" style="margin-top:15px">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="train_Time" name="train_Time">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    getSelectDataByIdObject.sql = 'TrainLogInfoMapper.selectInfo';
    ...
    function subData() {
        ...
        layerConfirm('确认提交？', ['确认', '取消'], [function () {                                                //**************
            ...
            getDataFnNoErrorF(                                                                                  //↓
                updateDataPath                                                                                  //↓
                , $('#formSearch').serialize() + '&sql=TrainLogInfoMapper.updateInfo&id=' + selectRowData    //↓
                , function (data) {                                                                             //↓
                    if (null != data) {                                                                         //↓
                        parent.query(1, true);                                                                    //↓
                        parent.layer.closeAll();                                                                //↓
