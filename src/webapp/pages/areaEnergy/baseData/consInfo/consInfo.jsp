    ...
    <link rel="stylesheet" type="text/css"
        ...
        <script type="text/javascript">
					...
					toolbar : [
						{
							...
							handler : function() {
								...
								var url="<%=basePath %>/pages/areaEnergy/baseData/consInfo/consSub.jsp?consId="+consId+'&voltCode='+voltCode;
								...
								handler:function(){
							        ...
							        var url="<%=basePath %>/pages/areaEnergy/baseData/consInfo/consTmnlList.jsp?subsId="+subsId+"&consId="+consId+"&areaNo="+areaNo;
									...
									$.messager.confirm('提示','确定要解除吗?',function(result){  
							            if (result){  
							                ...
							                $.each(rows,function(i,n){
							                    ...
							                    subsIdArr.push({'SUBS_ID' : rows[i].subsId});
							                });
			...
			function modifyTmnlInfo(saveFlag){
			   ...
			   $("#orgNo").combobox({disabled:saveFlag});
			   ...
			   $("#areaNo").combobox({disabled:saveFlag});
			...
			function doSave(result){
				if(result) {
					  ...
					  "&orgNo="+$('#orgNo').textbox('getValue')+"&telephone="+$('#telephone').textbox('getValue')+
					  ...
					  "&areaNo="+$('#areaNo').combobox('getValue')+"&areaConsName="+$('#areaConsName').textbox('getValue')+
									...
									<table style="width: 100%;" border="0">
										<tbody>
											<tr>
												...
												<td colspan="3">
													<table>
														<tr>
															<td>
																<input id="areaNo" name="queryPara.areaNo" value="${resultMap.AREA_NO}" size="27"
											...
											<tr>
												...
												<td>
													<input id="orgNo" type="hidden" name="queryPara.orgNo" value="" size="27" value="${resultMap.ORG_NO}">
												</td>
											</tr>
											<tr>
												<td colspan="6">
