    ...
    <div class="row">
        <div class="panel-body" style="padding-bottom:5px;" id="showPanel">
            <div class="panel panel-default">
                <div class="panel-heading">修改防疫</div>
...
<script type="text/javascript">
    ...
    getSelectDataByIdObject.sql = 'KennelAntiepidemicMapper.selectInfo';
    ...
    function subData() {
        ...
        layerConfirm('确认提交？', ['确认', '取消'], [function () {                                                //**************
            ...
            getDataFnNoErrorF(                                                                                  //↓
                updateDataPath                                                                                  //↓
                , $('#formSearch').serialize() + '&sql=KennelAntiepidemicMapper.updateInfo&id=' + selectRowData['id']    //↓
                , function (data) {                                                                             //↓
                    if (null != data) {                                                                         //↓
                        parent.query(1, 10);                                                                    //↓
                        parent.layer.closeAll();                                                                //↓
