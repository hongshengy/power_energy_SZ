  ...
  fireFileAddEvent : function(filename)
  {
    ...
    if(allExt && allExt.length>0){
        ...
        if(allExt.indexOf(extName+',')<0 && allExt.indexOf(','+extName)<0){
        	Ext.Msg.alert('提示','只能上传 '+allExt+' 类型的文件');
        	flag = false;
        	return false;
        }
    }
