...
<script type="text/javascript">
		...
		function loadEchartPageByLine(){
			...
			var option = {
			    ...
			    legend: {
			        data:['电流U(A)相曲线','电流V(B)相曲线','电流W(C)相曲线'],
			        x: 'center',
			      	y:'bottom'
		...
		function loadData(){
			var queryparam = "queryPara.LINE_ID="+lineId+"&queryPara.DATE_TIME="+dateTime+"&queryPara.QUERY_TYPE=01&queryPara.QUERY_PARA=02&queryPara.startSize="+station;
			$.ajax({
				type: "post",
