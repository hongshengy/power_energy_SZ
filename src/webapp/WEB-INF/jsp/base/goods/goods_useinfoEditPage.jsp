...
<div class="panel-body" style="padding-bottom:5px;">
    <div class="panel panel-default" id="showPanel">
        <div class="panel-heading">修改物资领用</div>
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                ...
                <div class="form-group" style="margin-top:15px">
                    ...
                    <div class="col-sm-5">
                        <textarea class="form-control" rows="5" id="goods_use_Content" name="goods_use_Content"></textarea>
                    </div>

                    <label class="control-label col-sm-1 text-nowrap" for="goods_use_Remark">物资领用说明</label>
                    <div class="col-sm-5">
                        <textarea class="form-control" rows="5" id="goods_use_Remark" name="goods_use_Remark"></textarea>
                    </div>
                </div>
...
//    根据ID获取当前选择的最新数据
    ...
    getSelectDataByIdObject.sql = 'GoodsUseInfoMapper.selectInfo';
    ...
    function subData() {
        ...
        layerConfirm('确认提交？', ['确认', '取消'], [function () {                                                //**************
            ...
            getDataFnNoErrorF(                                                                                  //↓
                updateDataPath                                                                                  //↓
                , $('#formSearch').serialize() + '&sql=GoodsUseInfoMapper.updateInfo&id=' + selectRowData['id']    //↓
                , function (data) {                                                                             //↓
                    if (null != data) {                                                                         //↓
                        parent.query(1, 10);                                                                    //↓
                        parent.layer.closeAll();                                                                //↓
