      ...
      <div id="content-panel" class="auto-resize easyui-panel main-panel " style="width: 100%;overflow-x:hidden" data-options="cls:'fangtian-panel-style bottom-padding',onResize:autoResize">
			<div style="width: 100%;position: relative;overflow-x:hidden;border:1px;" data-options="onResize:autoResize">
				...
				<div style="padding: 2px;">
					<div title="线路日用电走势"  class="main-panel" style="overflow-x:hidden;">   
						<div align="center" style="font-size:36px;">
							<font id="baseInfo_consName" style="font-weight:bold;"></font><br/>
							<font style="font-size:28px;"><font id="sDate"></font>用能日报</font>
						</div>	
					</div>
				</div>
				
				<div style="padding: 2px;">
					<div title="线路日用电走势"  class="main-panel" style="overflow-x:hidden;border:1px;">   
						<div class="easyui-panel noOverflow auto-resize" style="width:100%;" data-options="onResize:userResize">
						   <div id="myChart" class="chart" style="width: 100%;height:100%;min-height:220px;padding: 10px;"></div>
						</div>	
					</div>
				</div>
				<div style="padding:2px;">
					<div title="线路日用电详情"  class="main-panel" style="overflow-x:hidden;border:1px;">  
						<div class="easyui-panel" style="width: 100%;position: relative;padding:20px 100px;">
							<div align="center" style="font-size:36px;">
								<div class="content2" align="left">线路日用电（单位：kWh）</div>
								<div id="lineTable" class="content2"></div>
							</div>	
						</div>			
				</div>
				</div>
...
<script type="text/javascript" src="xlnh.js"></script>
</body>
</html>
