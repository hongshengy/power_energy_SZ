							...
							<td style="padding:5px;" width="100%">
									<table width="100%" cellspacing="8px" cellpadding="0"
										...
										<tr>
											...
											<td width="25%">
												<input type="text" size="18" id="outFactorySeq" disabled="disabled"  name="queryPara.outFactorySeq" class="easyui-textbox"  value="${resultMap.OUT_FACTORY_SEQ}">
											</td>
										</tr>
										<tr>
											<td class="td-label" align="right" nowrap="nowrap">
											...
											<td>
												<input type="text" class="easyui-datebox" disabled="disabled"  data-options="width:140" id="manufactDate" name="queryPara.manufactDate" value="${resultMap.MANUFACT_DATE}"/>
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												产品型号
											</td>
										...
										<tr>
											...
											<td>
												<input id="ssize" class="easyui-numberbox" disabled="disabled" value="${resultMap.S_SIZE}"  name="queryPara.ssize" style="width: 140px;" data-options="validType:'length[1,16]',required:false,precision:2">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												额定电压
											</td>
											<td width="25%">
					                             <input id="STANDARD_VOLT_H" class="easyui-numberbox" disabled="disabled"  name="queryPara.STANDARD_VOLT_H" style="width: 140px;"  value="${resultMap.STANDARD_VOLT_H}" data-options="validType:'length[1,16]',required:false,precision:4">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												额定电流
											</td>
											<td width="25%">
					                             <input id="STANDARD_CURRENT_H" class="easyui-numberbox" disabled="disabled"  name="queryPara.STANDARD_CURRENT_H" style="width: 140px;"  value="${resultMap.STANDARD_CURRENT_H}" data-options="validType:'length[1,16]',required:false,precision:4">
											</td>
										</tr>
										<tr>
											<td class="td-label" align="right" nowrap="nowrap">
											...
											<td width="25%">
					                             <input id="LIGHT_FLUX" class="easyui-numberbox" value="${resultMap.LIGHT_FLUX}" disabled="disabled"  name="queryPara.LIGHT_FLUX" style="width: 140px;" data-options="validType:'length[1,16]',required:false,precision:2">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												数量
											</td>
											<td width="25%">
					                             <input id="QUANTITY" class="easyui-numberbox" value="${resultMap.QUANTITY}" disabled="disabled"  name="queryPara.QUANTITY" style="width: 140px;" data-options="validType:'length[1,16]',required:false,precision:2">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												使用光源
											</td>
											<td>
												<input size="18" id="LIGHT_SOUECE" disabled="disabled"  name="queryPara.LIGHT_SOUECE" >
											</td>
										</tr>
										<tr>
											<td class="td-label" align="right" nowrap="nowrap">
											...
											<td width="25%">
					                             <input id="STANDARD_POWER" class="easyui-numberbox" disabled="disabled"  value="${resultMap.STANDARD_POWER}" name="queryPara.STANDARD_POWER" style="width: 140px;" data-options="validType:'length[1,16]',required:false,precision:4">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												功率因数
											</td>
											<td width="25%">
					                             <input id="POWER_FACTORS" class="easyui-numberbox" disabled="disabled"  value="${resultMap.POWER_FACTORS}" name="queryPara.POWER_FACTORS" style="width: 140px;" data-options="validType:'length[1,16]',required:false,precision:4">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												光效
											</td>
											<td width="25%">
					                             <input id="SUNLIGHT" class="easyui-numberbox" value="${resultMap.SUNLIGHT}" disabled="disabled"  name="queryPara.SUNLIGHT" style="width: 140px;" data-options="validType:'length[1,16]',required:false,precision:2">
											</td>
										</tr>
										<tr>
											<td class="td-label" align="right" nowrap="nowrap">
    ...
    var mpType = "";
        ...
        $(function() { 
          ...
          //设备种类
            ...
            //下拉框赋值
            $("#excuteStandard").combobox({value:'${resultMap.EXCUTE_STANDARD}'});
            $("#LIGHT_SOUECE").combobox({value:'${resultMap.LIGHT_SOUECE}'});
			$("#productKind").combobox({value:'${resultMap.PRODUCT_KIND}'});
			$("#deviceKind").combobox({value:'${resultMap.DEVICE_KIND}'});
            ...
            $("#excuteStandard").combobox({disabled:true});
            $("#productKind").combobox({disabled:true});
            $("#deviceKind").combobox({disabled:true});
   ...
   function onEndEdit(index, row){
    ...
    function OpenWin(url, winName, width, height, properties) 
    {
        ...
        function modifyTmnlInfo(saveFlag){
           ...
           $("#outFactorySeq").textbox({disabled:saveFlag});
           $("#manufactDate").textbox({disabled:saveFlag});
           $("#LIGHT_SOUECE").combobox({disabled:saveFlag});
           $("#ssize").numberbox({disabled:saveFlag});
           $("#STANDARD_VOLT_H").numberbox({disabled:saveFlag});
           $("#STANDARD_CURRENT_H").numberbox({disabled:saveFlag});
           $("#STANDARD_POWER").numberbox({disabled:saveFlag});
           $("#POWER_FACTORS").numberbox({disabled:saveFlag});
           $("#SUNLIGHT").numberbox({disabled:saveFlag});
           $("#LIGHT_FLUX").numberbox({disabled:saveFlag});
           $("#QUANTITY").numberbox({disabled:saveFlag});
           $("#size").numberbox({disabled:saveFlag});
           $("#factoryCode").combobox({disabled:saveFlag});
           $("#runStatus").combobox({disabled:saveFlag});
           $("#validFlag").combobox({disabled:saveFlag});
           $("#deviceKind").combobox({disabled:saveFlag});
           $("#productKind").combobox({disabled:saveFlag});
           $("#excuteStandard").combobox({disabled:saveFlag});
           if(saveFlag){
