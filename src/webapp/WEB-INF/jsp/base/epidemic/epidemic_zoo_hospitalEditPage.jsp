    ...
    <div class="row">
        <div class="panel-body" style="padding-bottom:5px;" id="showPanel">
            <div class="panel panel-default">
                <div class="panel-heading">修改动物医院</div>
...
<script type="text/javascript">
    ...
    getSelectDataByIdObject.sql = 'EpidemicZooHospitalMapper.selectInfo';
    ...
    function subData() {
        ...
        layerConfirm('确认提交？', ['确认', '取消'], [function () {                                                //**************
            ...
            getDataFnNoErrorF(                                                                                  //↓
                updateDataPath                                                                                  //↓
                , $('#formSearch').serialize() + '&sql=EpidemicZooHospitalMapper.updateInfo&id=' + selectRowData['id']    //↓
                , function (data) {                                                                             //↓
                    if (null != data) {                                                                         //↓
                        parent.query(1, 10);                                                                    //↓
                        parent.layer.closeAll();                                                                //↓
