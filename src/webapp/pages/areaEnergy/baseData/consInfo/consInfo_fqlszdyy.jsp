    ...
    <link rel="stylesheet" type="text/css"
        ...
        <script type="text/javascript">
			...
			function modifyTmnlInfo(saveFlag){
			   ...
			   $("#aisle").textbox({disabled:saveFlag});
		    	...
		    	$.ajax({
					...
					success: function(data) {
						if (data.rows.length > 0) {
						    ...
						    $('#orgNo').combotree('setValues',[{id: id, text: text}]);
						} 
					}
				});
		    }
			...
			function doSave(result){
				if(result) {
					  ...
					  "&TRADE_CODE="+$('#TRADE_CODE').combobox('getValue')+"&aisle="+$('#aisle').textbox('getValue')+
		    ...
		    <div title="电力客户" style="">  
		        <div id="consDiv" class="easyui-panel" title="客户信息" style="border: 0; height:570px; width:100%;overflow: auto; background: #fafafa;padding:0">
				  <form id="thisform" method="post">
				    <input type="hidden" id='consId' name='queryPara.consId' value="${resultMap.CONS_ID}">
				    <input type="hidden" id="areaNo" name="queryPara.areaNo" value="991">
									...
									<table style="width: 100%;" border="0">
										<tbody>
											<tr>
												...
												<td>
													<input id="consNo" name="queryPara.consNo" value="${resultMap.CONS_NO}" maxLength=12 
						                        ...
						                        <td>
						                        	<input id="orgNo" name="queryPara.ORG_NO" value="${resultMap.ORG_NO}"
						                           		data-options="required:true,missingMessage:'请选择供电公司'" style="width:195px;" />
													<font style="color: red;">*</font>
						                        </td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td width="25%">
													<input id="aisle" name="queryPara.aisle" value="${resultMap.AISLE}"
														size="27" class="easyui-numberbox" validType="validType:'length[0,30]',required:true,missingMessage:'请输通道信息'"  >
													<font style="color: red;">*</font>
												</td>
												<td class="td-label" align="center">
												</td>
