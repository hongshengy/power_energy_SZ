...
<script type="text/javascript">
			...
			var option = {
			    ...
			    tooltip : {
			        ...
			        formatter: function(params) {
			        	var paramResult = '时间: '+ params[0].name + ':00<br/>';//dateTime +' '+ 
		...
		function loadData(){
			var queryparam = "queryPara.LINE_ID="+lineId+"&queryPara.DATE_TIME="+dateTime+"&queryPara.QUERY_TYPE=01&queryPara.ORG_NO=01&queryPara.QUERYSIZE=24&queryPara.DATA_TYPE="+dateType;
			$.ajax({
				type: "post",
