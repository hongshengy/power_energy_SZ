...
#right_panel .panel-tool-collapse {
	background: url(../common/images/expand-left.png) no-repeat;
}

#right_panel .panel-tool-expand {
	background: url(../common/images/expand-down.png) no-repeat;
}
		...
		<div id="user-search">
			<div class="search-panel">
				...
				<div class="search-button" onclick="getResult()">
					<img src="../common/images/gis_search.png">
				</div>
			</div>
			<div id="searchResult"
				style="border: 1px solid #A4A4A4;position: absolute;left: 10px;right: 40px;">
				<ul id="searchResultUl" style="background-color: white;padding: 5px;margin: 0px;overflow: auto;height: 200px;">
			...
			<div id="ssxx_panel" class="easyui-panel">
				<div style="margin: 5px 10px;">
					<table>
						...
						<tbody>
							<tr>
								<td><img src="../common/images/gis-qy-normal.png" width="23px" height="28px"/></td>
                        		<td style="text-align: center;">正常</td>
                        		<td><input type="checkbox" checked onchange="map.khNormalChange(mp, $(this).is(':checked'));" /></td>
                        		<td><div id="khExplainNormal" style="margin-left:40px;line-height:20px;background-color: #60BA61;border: 1px solid #F2F2F2;
...
<!-- 								<td id="khExplainNormal">正常（0）</td> -->
							...
							<tr>
								<td><img src="../common/images/gis-qy-warning.png" width="23px" height="28px"/></td>
                        		<td style="text-align: center;">告警</td>
                        		<td><input type="checkbox" checked onchange="map.khWarningChange(mp, $(this).is(':checked'));" /></td>
                        		<td><div id="khExplainWarning" style="margin-left:40px;line-height:20px;background-color: #E76353;border: 1px solid #F2F2F2;
                        				border-radius: 4px;text-align: center;color: #FFFFFF;width:60px;height:20px;">
                        			</div>
                        		</td>
<!-- 								<td style="text-align: center;"><input type="checkbox" -->
...
<!-- 								<td id="khExplainWarning">告警（0）</td> -->
							...
							<tr>
								<td><img src="../common/images/gis-qy-interrupt.png" width="23px" height="28px"/></td>
                        		<td style="text-align: center;">中断</td>
                        		<td><input type="checkbox" checked onchange="" /></td>
                        		<td><div id="khExplainBreak" style="margin-left:40px;line-height:20px;background-color: #F7AC63;
			...
			<div id="xxhz_panel" class="easyui-panel">
				<div style="margin: 5px 10px;">
					<table>
						...
						<tbody>
							<tr>
								<td><img src="../common/images/gis-bdz-normal.png" width="28px" height="28px"/></td>
                        		<td style="text-align: center;">正常</td>
                        		<td ><input type="checkbox" checked onchange="map.bdzNormalChange(mp, $(this).is(':checked'));" /></td>
                        		<td><div id="bdzExplainNormal" style="margin-left:40px;line-height:20px;background-color: #60BA61;border: 1px solid #F2F2F2;
                        				border-radius: 4px;text-align: center;color: #FFFFFF;width:60px;height:20px;">
                        			</div>
                        		</td>
<!-- 								<td style="text-align: center;"><input type="checkbox" -->
...
<!-- 								<td id="bdzExplainNormal">正常（0）</td> -->
							...
							<tr>
								<td><img src="../common/images/gis-bdz-warning.png" width="28px" height="28px"/></td>
                        		<td style="text-align: center;">告警</td>
                        		<td ><input type="checkbox" checked onchange="map.bdzWarningChange(mp, $(this).is(':checked'));" /></td>
                        		<td><div id="bdzExplainWarning" style="margin-left:40px;line-height:20px;background-color: #E76353;border: 1px solid #F2F2F2;
                        				border-radius: 4px;text-align: center;color: #FFFFFF;width:60px;height:20px;">
                        			</div>
                        		</td>
<!-- 								<td style="text-align: center;"><input type="checkbox" -->
...
<!-- 								<td id="bdzExplainWarning">告警（0）</td> -->
							...
							<tr>
								<td><img src="../common/images/gis-bdz-interrupt.png" width="28px" height="28px"/></td>
                        		<td style="text-align: center;">中断</td>
                        		<td><input type="checkbox" checked onchange="" /></td>
                        		<td><div id="bdzExplainBreak" style="margin-left:40px;line-height:20px;background-color: #F7AC63;
                        				border: 1px solid #F2F2F2;border-radius: 4px;text-align: center;color: #FFFFFF;width:60px;height:20px;">
                        			0</div>
                        		</td>
<!-- 								<td style="text-align: center;"><input type="checkbox" -->
...
<!-- 								<td id="bdzExplainBreak">中断（0）</td> -->
		...
		<div id="left-bottom-panel">
			...
			<div class="img-panel" onClick="openfh();">
				<img src="../common/images/gis-fh.png" width="50%" height="50%"
					border="0" />
				<div class="labeltitle">实时负荷</div>
				<div id="gisfh" class="labelnum"></div>
			</div>
			<div class="img-panel" onClick="opendl();">
				<img src="../common/images/gis-dl.png" width="50%" height="50%"
					border="0" />
			...
			<div class="img-panel" onClick="userTotal();">
				<img src="../common/images/gis-qy.png" width="50%" height="50%"
					border="0" />
...
<!--  			<div class="img-panel" onClick="xsData(101000001078,2);"> -->
				<img src="../common/images/gis-bdz.png" width="50%" height="50%"
					border="0" />
...
<!--   			<div class="img-panel" onClick="xsData(101000001077,1);"> -->
				<img src="../common/images/gis-gj.png" width="50%" height="50%"
					border="0" />
			...
			<div class="img-panel" onClick="zbCount();">
				<img src="../common/images/gis-zb.png" width="50%" height="50%"
					border="0" />
...
<!--  			<div class="img-panel" onClick="khRealTimeFh(109900007433,2);"> -->
 				<img src="../common/images/gis-zbrl.png" width="50%" height="50%"
					border="0" />
...
<!--   			<div class="img-panel" onClick="khRealTimeFh(109900007431,1);"> -->
 				<img src="../common/images/gis-gd.png" width="50%" height="50%"
					border="0" />
...
<script type="text/javascript" src="GISZongLan.js"></script>
