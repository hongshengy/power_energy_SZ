...
var node=$(this);
var item=$.extend({},$.parser.parseOptions(this,["id","iconCls","state"]),{checked:(node.attr("checked")?true:undefined)},{showCheck:(node.attr("showCheck")?true:undefined)});
...
$(this).find(".menu-text").css({height:(opts.itemHeight)+"px",lineHeight:(opts.itemHeight)+"px"});
});
