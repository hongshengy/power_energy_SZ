...
String energyCellId = request.getParameter("energyCellId");//获取调用父页面传过来的参数
String dlzsEDateD = request.getParameter("dlzsEDateD");//获取调用父页面传过来的参数
//consId="101000004001";
//consName="立霸实业有限公司";
...
height:300px;
    ...
    <div class="main-panel noOverflow" data-options="region:'center'" >
   		<div class="easyui-panel" style="width:100%;position: relative;"  data-options="cls:'fangtian-panel-style',onResize:autoResize">
			<ul class="s-ul-one" >
				<li>
					...
					<span class="tools-labelgroup">
				     	 <select class="easyui-combobox" id="selectDev"  data-options="editable:false,width:120,panelHeight:'auto'" >
				     	 </select>
					</span>
					<span class="tools-labelgroup">
				     	 统计频率：
					...
					<span class="tools-labelgroup">
				     	 <select class="easyui-combobox" id="selectType"  data-options="editable:false,width:120,panelHeight:'auto',panelWidth:120" >
				     	 </select>
					</span>
					<span id="dayDateDiv">
				    <span class="tools-labelgroup" style="position:relative;top:-2px;vertical-align:middle;border-style:none;">
                    ...
                    <span class="tools-labelgroup" style="position:relative;top:-2px;vertical-align:middle;">
                         <input type="text" class="Wdate" style="text-align: left;width:120px;" data-options="width:120,editable:false" id="dataDate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',onpicked:changeDate,isShowClear:false,readOnly:true})"/>
					</span>
					<span class="tools-labelgroup" style="position:relative;top:-2px;vertical-align:middle;border-style:none;">
					...
					<span id="monthDateDiv" style="display:none;">
				    <span class="tools-labelgroup" style="position:relative;top:-2px;vertical-align:middle;border-style:none;">
         				<a onclick="" id="left" href="javascript:qytQueryOveride('-1');" style="border-style:none;"> 
         				 	<img alt="前一天" src="<%=request.getContextPath()%>/images/tools-moveleft.gif" height="14px" width="14px" style="border-style:none;vertical-align: middle;">
				 		</a>
                    ...
                    <span class="tools-labelgroup" style="position:relative;top:-2px;vertical-align:middle;">
                         <input type="text" class="Wdate" style="text-align: left;width:120px;" data-options="width:120,editable:false" id="monthDate" onClick="WdatePicker({dateFmt:'yyyy-MM',onpicked:changeDate,isShowClear:false,readOnly:true})"/>
					</span>
					<span class="tools-labelgroup" style="position:relative;top:-2px;vertical-align:middle;border-style:none;">
						<a onclick="" id="right" href="javascript:qytQueryOveride('1');" style="border-style:none;"> 
							<img alt="后一天" src="<%=request.getContextPath()%>/images/tools-moveright.gif" height="14px" width="14px" style="border-style:none;vertical-align: middle;">
      ...
      <div id="content-panel" class="auto-resize easyui-panel main-panel " style="width: 100%;" data-options="cls:'fangtian-panel-style bottom-padding',onResize:autoResize">
			<div style="width: 100%;position: relative;border:1px;" data-options="onResize:autoResize">
				<div id="baseInfo_consName" class="title1" style="text-align:center;"></div>
				<div id="baseInfo_ps" class="title2" style="text-align:right;"></div>
...
<script type="text/javascript">
		...
		var funcId = "<%=funcId%>";
		var energyCellId = "<%=energyCellId%>";
		var dlzsEDateD = "<%=dlzsEDateD%>";
</script>
...
<script type="text/javascript" src="boilerEnergyTable.js"></script>
</body>
</html>
