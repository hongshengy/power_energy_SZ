...
<html>
	<head>
		...
		function doSubmit(result){
			if(result) {
				...
				"&voltCode="+$('#voltCode').textbox('getValue')+"&others="+$('#others').textbox('getValue')+"&pConsId="+'${param.consId}'+
				"&parentId="+'${param.parentId}'+"&subsId="+'${param.subsId}';
				$.ajax({
					url : des.webContextRoot +'capacity/updateElecDevice.action',
					type: "post",
					dataType:"text",
					data : para,
					timeout:60000, 
    ...
    <body srolling='no'>
		<div id='queryDiv' class="container-shadow container-marginTop" style="width:100%;">
            <div class="easyui-panel" title="编辑电器设备" style="width:100%;">
									...
									<table width="100%" cellspacing="8px" cellpadding="0"
										...
										<tr>
			                                ...
			                                <td >
			                                    ...
			                                    data-options="required:true,missingMessage:'请输入电器名称'" value="${param.name}">
			                             ...
			                             <tr>
			                                ...
			                                <td>
			                                	<input class="easyui-textbox" id="pNo" size="30" value="${param.pNo }"/> 
			                                </td>
			                             </tr>
			                             <tr>
			                                ...
			                                <td>
			                                	<input class="easyui-textbox" size="30" id="voltCode" value="${param.voltCode }"/>
			                                </td>
			                            </tr>
			                            <tr>
			                                <td class="td-label" align="right">其他铭牌信息：</td>
			                                <td colspan = '4'>
			                                    <input class="easyui-textbox" data-options='multiline:true' value="${param.others }" id="others" style= "width:550px;height:100px;">
			                                </td>
			                            </tr>
									</table>
							</td>
