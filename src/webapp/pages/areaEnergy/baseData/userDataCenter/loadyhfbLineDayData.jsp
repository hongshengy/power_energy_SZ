...
<body style="overflow:scroll;height: 100%;width: 100%; ">
	<div id="dataDIV" style="height: 100%;width: 100%;">
		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					<th width="20%" align="center" data-options="field:'timeData'">数据时间</th>
					<th width="20%" align="center" data-options="field:'jxzgl1'">正向有功(kWh)</th>
					<th width="20%" align="center" data-options="field:'jxzgl2'">正向无功(kWh)</th>
					<th width="20%" align="center" data-options="field:'jxzgl3'">反向有功(kWh)</th>
					<th width="20%" align="center" data-options="field:'jxzgl4'">反向无功(kWh)</th>
				</tr>
			</thead>
			<tbody>
					...
					<tr>
							...
							<td>${data.ENERGY_PAP}</td>
							<td>${data.ENERGY_PRP}</td>
							<td>${data.ENERGY_RAP}</td>
							<td>${data.ENERGY_RRP}</td>
					</tr>
					</c:forEach>
			</tbody>
		</table>
