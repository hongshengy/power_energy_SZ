	...
	onRender : function(a, h) {
		...
		c
				.push(
						...
						this.showToday
								? '<tr><td colspan="3" align="center"><table border="0" width="100%" cellspacing="0"><tr><td class="x-date-bottom1" align="center" width="95%"></td><td class="x-date-bottom2">&nbsp;</td><tr></table></td></tr>'
		...
		if (this.showToday) {
			...
			this.todayBtn = new Ext.Button({
						renderTo : this.el.child("td.x-date-bottom1", true),
