		...
		<div id="content-panel" class="auto-resize easyui-panel main-panel noOverflow" style="width: 100%;" data-options="cls:'fangtian-panel-style bottom-padding'">
				...
				<ul class="s-ul-one" >
					<li>
					   <span class="tools-labelgroup">
					   	 <select class="easyui-combobox" id="sbType"  data-options="width:155,panelHeight:'auto',panelWidth:155"></select>
					   </span>
					   <span class="tools-labelgroup" style="vertical-align:middle;border-style:none;">
						...
						<span class="tools-labelgroup">
					   	  <select id="QueryType" class="easyui-combobox" data-options="prompt:'请选择',panelHeight:'auto',editable:false,width:155,panelHeight:'auto',panelWidth:155"></select>
					    </span>
					</li>
			...
			<div class="easyui-panel auto-resize" style="width: 100%;position: relative;" data-options="border:false,onResize:userResize">
				<!-- <div id="tabs" class="easyui-tabs" style="width: 100%;height: 100%;" data-options="border:false">
				   <div id="yqjc" title="用气监测" class="main-panel auto-resize noOverflow" data-options="selected:true,onResize:autoResize">
						<div class="auto-resize easyui-panel" style="width: 100%;" data-options="border:false,onResize:userResize"> -->
						   <div id="yqjcChart" class="chart" style="width: 100%;height:100%;padding: 10px;box-sizing: border-box;"></div>
						<!-- </div>
				   </div>
			   </div> -->
		   </div>
...
<script type="text/javascript" src="gasMonitor.js"></script>
</body>
</html>
