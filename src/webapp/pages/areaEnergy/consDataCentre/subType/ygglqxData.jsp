		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th width="20%" align="center" data-options="field:'jxzgl'">总(kW)</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">A相(kW)</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">B相(kW)</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">C相(kW)</th>
				</tr>
			</thead>
			<tbody>
