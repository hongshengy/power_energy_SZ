 ...
 * </p>
 */
des.namespace("com.frontier.areaEnergy.treeThreeLevelDB");
...
$(function() { 
	...
	$('#cbzdTable').datagrid({
			...
			fitColumns: true,  
			url : des.webContextRoot+'areaEnergy/getMetetInfoByCBZD.action?queryPara.meterId='+meterId,
			sortOrder : 'desc',
			remoteSort : false,
			showFooter : true,
			autoRowHeight : false,
