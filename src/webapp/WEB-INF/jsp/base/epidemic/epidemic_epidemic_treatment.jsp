...
<div class="panel-body" style="padding:5px;">
    <div class="panel panel-default">
        <div class="panel-heading">疫病治疗管理</div>
    ...
    <div id="toolbar" class="btn-group">
        ...
        <%--<button id="btn_preview" type="button" class="btn btn-default" onclick="preview();">--%>
...
<script type="text/javascript">
    ...
    var pageDataSql = 'EpidemicEpidemicTreatmentMapper.getListByParamsByPage';
    ...
    var columns = [
        {
            ...
            field: 'epidemic_Effect',
            title: '治疗效果'
        }, {
            field: 'epidemic_location',
            title: '治疗地点'
        }
    ];
...
//    添加
    function add() {
        layerOpenFn('${showPagePath}','添加疫病治疗','base/epidemic/epidemic_epidemic_treatmentPage',bodyW-100, bodyH);
    }

    //    修改
    function edit() {
        if($('#tb_departments').bootstrapTable('getSelections').length == 1){
            layerOpenFn('${showPagePath}','编辑疫病治疗', 'base/epidemic/epidemic_epidemic_treatmentEditPage', bodyW-100, bodyH);
        }else {
    ...
    //    删除
    function deleteFun() {
        sysDeleteFun('EpidemicEpidemicTreatmentMapper.deleteInfo');
    }
...
//    }
    ...
    $('#btn_export').click(function () {
        var mmm = ['疫病名称','治疗效果','生病日期','治疗日期','芯片号','治疗地点','','','检疫犬名','芯片号',''];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=EpidemicEpidemicTreatmentMapper.selectInfo&fileName=疫病治疗管理&titleParams='+titleParams);
    });
</script>
