		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th width="25%" align="center" data-options="field:'jxzgl1'">母排温度U(A)相曲线(℃)</th>
					<th width="25%" align="center" data-options="field:'jxzgl2'">母排温度V(B)相曲线(℃)</th>
					<th width="25%" align="center" data-options="field:'jxzgl3'">母排温度W(C)相曲线(℃)</th>
				</tr>
			</thead>
			<tbody>
