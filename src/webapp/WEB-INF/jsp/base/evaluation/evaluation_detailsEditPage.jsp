    ...
    <div class="row">
        <div class="panel-body" style="padding-bottom:5px;" id="showPanel">
            <div class="panel panel-default">
                <div class="panel-heading">编辑检疫犬考评</div>
...
<script type="text/javascript">
    ...
    getSelectDataByIdObject.sql = 'EvaluationDetailsInfoMapper.selectInfo';
    ...
    function subData() {
        ...
        if(fexSelectFlg){
            if(!AFFIXFlg){
                //        发起layer询问框
                layerConfirm('未上传选择的附件确认提交？', ['确认', '取消'], [function () {                                                //**************
                    //正常提交数据
                    //发起update请求
                    getDataFnNoErrorF(                                                                                  //↓
                        updateDataPath                                                                                  //↓
                        , $('#formSearch').serialize() + '&sql=EvaluationDetailsInfoMapper.updateInfo&id=' + selectRowData['id']    //↓
                        , function (data) {                                                                             //↓
                            if (null != data) {                                                                         //↓
                                parent.query(1, 10);                                                                    //↓
                                parent.layer.closeAll();                                                                //↓
