...
* {
	...
	<script type="text/javascript">
		 ...
		 function loadQydlBar(){
		    ...
		    +"&queryPara.ORG_NO=02&queryPara.TYPE=LC&queryPara.startSize="+station;
			document.getElementById("jcxtpFrame").src = basePath+"pages/areaEnergy/baseData/illumination/illuminationTabPic.jsp?device="+device+"&data="+data+"&type=LC&station="+station;
	 	 	document.getElementById("jcxsjFrame").src = basePath+"/userDataCenterAction/illuminationTabSou.action?"+queryparam;
		 }
