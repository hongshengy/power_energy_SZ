	...
	<div id="divPanel" class="easyui-dialog" closed="true" modal="true" title="" display: none" data-options="minimizable:false,collapsible:false">
		<div style="margin-left:10px;margin-right:10px; margin-top:10px;margin-bottom:10px; " id="radio">
			<table align="center" style="margin-left:20px;margin-right:10px">					
				...
				<tr>
					<td class="lab" ><label style="white-space:nowrap">交接班事项：</label></td>
				...
				<tr>
					<td colspan="2">
						...
						<span style="float:right;margin-right:10px">交班人：<input id="dealTkUser" class="easyui-textbox" style="height:24px;width:160px" data-options="required:true,validType:['length[0,32]']"/></span>
						<span style="float:right;margin-right:10px">接班人：<input id="carryTkUser" class="easyui-textbox" style="height:24px;width:160px" data-options="required:true,validType:['length[0,32]']"/></span> 
					</td>
				</tr>																														
			</table>			
...
<script type="text/javascript" src="<%=basePath %>pages/despages/warn/changeShiftsManage.js" ></script> 
