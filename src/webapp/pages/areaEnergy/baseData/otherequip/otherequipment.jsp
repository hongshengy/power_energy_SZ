...
<html>
					...
					<tr>
						<td style="padding: 5px;" width="100%">
							<fieldset
								...
								<legend>
									<font style="font-size: 12px; font-weight: bold;">其他设备</font>
								</legend>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
         	...
         	$('#cxTab').tabs({    
				    ...
				    onSelect:function(title,index){
				        ...
				        if(index == 0){
				        	...
				        	var tabSign = $('#view5').parent().attr('id');
				        	document.getElementById("Frame5").src =  basePath+"pages/areaEnergy/consDataCentre/xlcdsssjTAB.jsp?subId="+subId+"&lineId="+device+"&mpType="+mpType+"&riqiIn="+searchrq+"&hheight="+mainHeight+"&tabSign="+tabSign+"&ddType=W";
				        }
				    }   
			  }); 
			...
			var tabSign = $('#view'+num).parent().attr('id');
        	//默认显示 
            document.getElementById("Frame4").src = basePath+"pages/areaEnergy/baseData/otherequip/otherequipmentTab.jsp?device="+device+"&data="+searchrq+"&station="+station+"&tabSign="+tabSign;
            //下拉框触发改变事件
			$("#searchmc").combobox({
				onChange:function(newValue,oldValue){
					parent.document.getElementById("rightFrame").src = basePath+"areaEnergy/queryOtherEquipment.action?queryPara.subId="+subId+"&queryPara.id="+newValue+"&queryPara.other="+other+"&queryPara.isdevice="+isdevice;
				} 
			});
		 });
