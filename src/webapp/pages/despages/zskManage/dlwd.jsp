...
<script>
	...
	<div class="main-panel noOverflow" data-options="region:'center',border:false" >
					...
					<ul class="s-ul-one" >
						<li>
						    <span class="tools-labelgroup">
						         <select class="easyui-combobox" id="sbType" style="width:130px" data-options="width:130,panelHeight:'auto'"></select>
							</span>
			                <span class="tools-labelgroup" >
	                        ...
	                        <span class="tools-labelgroup" style="vertical-align:middle;">
	                             <input type="text" class="easyui-datebox" style="width:100px;text-align: left;" data-options="width:100,editable:false" id="dataDate" />
							</span>
							...
							<span class="tools-labelgroup">
								<select id="QueryType" class="easyui-combobox" style="width:130px" data-options="prompt:'请选择',panelHeight:'auto',editable:false"></select>
							</span>
						</li>
       ...
       <div id="c-panel" class="main-panel auto-resize easyui-panel noOverflow" style="width: 100%;" data-options="border:false,onResize:autoResize">					
        <div class="auto-resize easyui-panel" style="width: 100%;border-bottom:solid 1px #CCCCCC" data-options="border:false,onResize:userResize">
			<div class="chart" id="wdjcChart" style="width: 100%;height:100%;padding: 10px;box-sizing: border-box;"></div>
		</div>
		<div id="tab-fzl" class="local-panel block2 panel-margin-top clearfix" style="margin-bottom:1px;border-bottom-color:white;">
				<div style="margin: 35px; ">
					<p style="font-size: 20px; color: #B763D8;">
						 电缆温度分析：<span id="currentTime"></span>日，电缆最高温度为：<span id="maxValue"></span>℃,
						 电缆最低温度为：<span id="minValue"></span>℃, 温度越限次数为：<span class="num" id="yxcount"></span>次
					</p>
				</div>
		</div>
			<!-- 	<div class="easyui-panel auto-resize" style="width: 100%;position: relative;" data-options="border:false">
					<div id="tabId" class="easyui-tabs" style="width: 100%;height: 100%;" data-options="border:false">
						<div id="wdjc" title="电缆温度" class="main-panel auto-resize noOverflow" data-options="selected:true,onResize:autoResize">
						<div class="auto-resize easyui-panel" style="width: 100%;" data-options="border:false,onResize:userResize">
						   <div id="wdjcChart" class="chart" style="width: 100%;min-height:280px;height:100%;padding: 10px;box-sizing: border-box;border-bottom:solid 1px #CCCCCC;"></div>
						</div>
						<div style="margin: 35px; ">
							<p style="font-size: 20px; color: #B763D8;">
								 电缆温度分析：<span id="currentTime"></span>日，电缆最高温度为：<span id="maxValue"></span>℃,
...
<script type="text/javascript" src="dlwd.js"></script>
