    ...
    <div class="main-panel noOverflow" data-options="region:'center'" >
        	 ...
        	 <div class="easyui-panel show-bottom-border" style="width: 100%;position: relative;" data-options="onResize:autoResize,border:false">
         			...
         			<li>
	         			<span class="tools-labelgroup">
		               	 <select class="easyui-combobox" id="byq"  data-options="width:120,panelHeight:'auto',panelWidth:120" ><!-- byq -->
			               	 <option value="ddadad">水阀</option>
			               	 <option value="ddada">水泵</option>
			               	 <option value="ddaad">水表</option>
			               	 <option value="dadad">水箱</option>
			               	 <option value="adad">气压给水设备</option>
		               	 </select>
					  	</span>
                       ...
                       <span class="tools-labelgroup" style="vertical-align:middle;">
                           	<input id="startDate" class="Wdate" type="text" style="width: 100px;text-align: left;"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd',onpicked:changedlzs})"/>
					   </span>
					   <span class="tools-labelgroup" style="vertical-align:middle;border-style:none;">
			...
			<div class="easyui-panel auto-resize noOverflow" style="width: 100%;position: relative;" data-options="border:false">
				<div id="tabs" class="easyui-tabs" style="width: 100%;height: 100%;" data-options="border:false">
				    ...
				    <div id="mdyl-panel" title="流量" class="main-panel auto-resize " style="overflow-x:hidden;"  data-options="selected:true,onResize:autoResize">
						<!--图表-->
						<div class="auto-resize easyui-panel" style="width: 100%;min-height:280px;" data-options="border:false,onResize:userResize">
							<div class="chart" id="llChart" style="width: 100%;height:100%;padding: 10px;box-sizing: border-box;"></div>
						</div>
						
						<div id="tab-fzl" class="local-panel block2 panel-margin-top clearfix" style="border-bottom:0;border-left:0;border-right:0;">
							  <div class="col col1" style="width:49%">
									<div class="innerBox" style="height:65px;padding: 30px 0px 0px 0px;">
										<p class="label" style="color: #37A09D">
											流量上限越限次数<span class="num" id="avgCrBCsx">3</span>次
										</p>
									</div>
							 </div>
							<div class="col col2" style="width:50%">
								<div class="innerBox" style="height:65px;padding: 30px 0px 0px 0px;">
									<p class="label" style="color: orange">
										流量下限越限次数<span class="num" id="avgCrBCsx">2</span>次
									</p>
								</div>
							</div>						
	              	    </div>
					 </div>
					<div id="scql-panel" title="温度" class="main-panel auto-resize " style="overflow-x:hidden;"  data-options="selected:true,onResize:autoResize">
						<!--图表-->
						<div class="auto-resize easyui-panel" style="width: 100%;min-height:280px;" data-options="border:false,onResize:userResize">
							<div class="chart" id="lsChart" style="width: 100%;height:100%;padding: 10px;box-sizing: border-box;"></div>
						</div>
						...
						<div id="tab-fzl" class="local-panel block2 panel-margin-top clearfix" style="border-bottom:0;border-left:0;border-right:0;">
							 <div class="col col1" style="width:49%">
									<div class="innerBox" style="height:65px;padding: 30px 0px 0px 0px;">
										<p class="label" style="color: #37A09D">
											温度上限越限次数<span class="num" id="avgCrBCsx">13</span>次
										</p>
									</div>
							 </div>
							<div class="col col2" style="width:50%">
								<div class="innerBox" style="height:65px;padding: 30px 0px 0px 0px;">
									<p class="label" style="color: orange">
										温度下限越限次数<span class="num" id="avgCrBCsx">5</span>次
									</p>
								</div>
							</div>							
		              	</div>
					...
					<div id="scqy-panel" title="压力" class="main-panel auto-resize " style="overflow-x:hidden;"  data-options="selected:true,onResize:autoResize">
							<!--图表-->
							<div class="auto-resize easyui-panel" style="width: 100%;min-height:280px;" data-options="border:false,onResize:userResize">
								<div class="chart" id="ycChart" style="width: 100%;height:100%;padding: 10px;box-sizing: border-box;"></div>
							</div>
							  <div id="tab-fzl" class="local-panel block2 panel-margin-top clearfix" style="border-bottom:0;border-left:0;border-right:0;">
								  <div class="col col1" style="width:49%">
										<div class="innerBox" style="height:65px;padding: 30px 0px 0px 0px;">
											<p class="label" style="color: #37A09D">
												压力上限越限次数<span class="num" id="avgCrBCsx">11</span>次
											</p>
										</div>
								 </div>
								<div class="col col2" style="width:50%">
									<div class="innerBox" style="height:65px;padding: 30px 0px 0px 0px;">
										<p class="label" style="color: orange">
											压力下限越限次数<span class="num" id="avgCrBCsx">6</span>次
										</p>
									</div>
								</div>							
			              	</div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript" src="<%=pagePath %>/echarts/echarts.min.js"></script>
  ...
  <script type="text/javascript" src="ysMonitor.js"></script>
