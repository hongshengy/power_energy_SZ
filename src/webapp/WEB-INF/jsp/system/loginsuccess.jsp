        ...
        <div data-options="region:'east',border:false" style="width:230px;">
            <div class="menu-userinfo-panel">
				        <span class="warining-block" style="">
				        	...
				        	<a class="warining-num" id ="gaojingsl" style="background-image: url('${basePath}images/warningNum-bg.png');" onclick="testOpen('',0,1,'','告警详情')"></a>
				        </span>
...
<script type="text/javascript">
    webContextRoot="http://61.177.76.218:7801/des/";
    webContextRoot2="${basePath}";
    loginUserId = "10099246636";
</script>
<script type="text/javascript" src="${basePath}pages/despages/common/jquery-easyui-1.5.1/jquery.min.js"></script>
<script type="text/javascript" src="${basePath}pages/despages/common/jquery-easyui-1.5.1/jquery.easyui.min.js"></script>
<script type="text/javascript" src="${basePath}pages/despages/common/jquery-easyui-1.5.1/easyui-lang-zh_CN.js"></script>
<script type="text/javascript" src="${basePath}pages/despages/common/js/common.js"></script>
...
<script>
    ...
    function firstpage(){
        ...
        setTimeout(function(){
            var  onepege='<iframe id="funcId" src="${basePath}/system/show?page='+'base/goods/goods_info' +'"scrolling="no" frameborder="0" width="100%" height="99%"></iframe>';
            $('#tab-main').tabs('add',{
                title:'首页',
    ...
    function menuHandler(item){
        ...
        if(dakai == 'N'){
            if(url.toLowerCase().indexOf("http://")==0){
                ...
                page='<iframe id="funcId" name="'+name+'" src="${basePath}/system/show?page='+url +'&consId='+consId+'&consName='+consName+'&isMainInto=true'+'" scrolling="no" frameborder="0" width="100%" height="100%"></iframe>';
            }
            ...
            if(url.toLowerCase().indexOf("http://")==0){
                ...
                content='<iframe id="funcId" name="'+name+'" src="${basePath}/system/show?page='+url +'"scrolling="no" frameborder="0" width="100%" height="100%"></iframe>';
            }
