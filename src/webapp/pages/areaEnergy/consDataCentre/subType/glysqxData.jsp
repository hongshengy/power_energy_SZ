		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th width="20%" align="center" data-options="field:'jxzgl'">总</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">A相</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">B相</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">C相</th>
				</tr>
			</thead>
			<tbody>
