...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		#login .icon-title-panel .icon{
			...
			width: 354px;
			height: 96px;
/* 			background-image: url('<%=pagePath%>/images/loginLogo_2.png'); */
	...
	<form name="LoginForm"  method="post">
		<div id="login">
				<div class="icon-title-panel">
					<div id="loginImage" class="icon"></div>
					<div class="title">
...
// 				    if(json[0].areaNo == '101'){
				    	...
				    	$('#loginImage').css("background-image", "url(<%=pagePath%>/images/loginLogo_2.png)");
// 				    }else {
// 				    	document.title="区域能源服务系统";
// 				    	$('#loginImage').css("background-image", "url(<%=pagePath%>/images/loginLogo_1.png)");
// 				    }
				}
			);
			//光标放在用户名输入框
