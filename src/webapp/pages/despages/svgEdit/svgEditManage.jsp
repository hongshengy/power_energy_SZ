...
<html>
    ...
    <style>
        ...
        .float-tool-block .icon-block.edit{
            background: url("svgEdit/images/icon_edit_16.png") no-repeat;
        }

        .float-tool-block .icon-block.config{
            background: url("svgEdit/images/icon_config_16.png") no-repeat;
        }

        .float-tool-block .icon-block.close{
            background: url("svgEdit/images/icon_close_16.png") no-repeat;
        }
...
/*         .tree-panel{
        ...
        .logo{
            ...
            min-width: 50px;
            min-height: 50px;
            background: url("svgEdit/images/loginLogo.png");
...
<div class="easyui-panel" style="width: 100%;position: relative;" data-options="cls:'fangtian-panel-style',onResize:autoResize">
    ...
    <div class="toolsbar-panel grid-label">
        <div class="tbRow">
            ...
            <span class="tools-labelgroup">
                <label class="tb-group-label">未配置一次图总数：</label>
...
<div id="dialog1" style="display: none">
    ...
    <div id="buttons" style="text-align: center;top: -15px;">
        <a href="#" id="insertSvg" class="easyui-linkbutton c100">保存</a>
        <a href="#" id="quitSvg" class="easyui-linkbutton c100">取消</a>
    </div>
</div>
<!-- 修改一次图 -->
<div id="Editdialog" style="display: none">
    ...
    <div id="buttons1" style="text-align: center;top: -15px;">
        <a href="#" id="editSvg" class="easyui-linkbutton c100">保存</a>
        <a href="#" id="quiteditSvg" class="easyui-linkbutton c100">取消</a>
    </div>
</div>
...
<script src="svgEdit/common.js"></script>
<script type="text/javascript" src="<%=pagePath%>/js/consSelect2.js"></script>
<script src="<%=basePath%>/pages/despages/svgEdit/svgEditManage.js" type="text/javascript"></script> 
</body>
</html>