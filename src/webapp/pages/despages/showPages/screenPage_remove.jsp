  ...
  <body>
  	<div id="main_div">
	  	<div id="pt-main" class="pt-perspective">
	        <div class="pt-page pt-page-1" style="background: transparent; width: 1920px; height: 960px;">
	            <iframe id="iframe0" name="iframe0" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="1920" height="960" src="<%=basePath%>/pages/despages/showPages/screenPageOne.jsp"></iframe>
	        </div>
	        <div class="pt-page pt-page-2" style="background: transparent; width: 1920px; height: 960px;">
	            <iframe id="iframe1" name="iframe1" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="1920" height="960" src="<%=basePath%>/pages/despages/showPages/childPages/pageFive.jsp"></iframe>
	        </div>
	    </div>
  	</div>
	...
	<div class="" style="font-size: 24px; opacity: 0; display: none; position: absolute; width: 1000px; height: 650px; border: 2px solid rgb(183, 188, 191); border-radius: 20px; margin-left: 450px; top: 150px; background: rgba(255, 255, 255, 0.9) none repeat scroll 0% 0%; transform: scale(0.2);" id="popWindow">
		<div style="height: 12%;">
			<div style="float: left; color: rgb(78, 78, 78); margin-top: 3%; margin-left: 5%;">
				<span id="popTxtSpan">山进特殊钢(江苏)有限公司</span>
			</div>
		...
		<div style="width: 900px; height: 550px; border: 2px solid rgb(185, 187, 187); margin-left: 5%;">
			<div id="divPlugin" class="plugin"><embed type="application/webvideo-plugin-kit" name="webVideoCtrl20170421133248" wndtype="1" playmode="2" colors="" align="middle" height="100%" width="100%"></div>
		</div>
	</div>
  	
    <script src="<%=jsPath%>/jquery.dlmenu.js"></script>
    <script src="<%=jsPath%>/pagetransitionsOne.js"></script>
