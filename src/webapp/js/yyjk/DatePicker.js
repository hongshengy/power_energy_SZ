/*
 * 介绍: 选择年月时间组件的DatePicker
 * 使用: 在需要使用年月控件的页面中加载此JS
 */
YYJK.DatePicker = Ext.extend(Ext.Component, {
    ...
    initComponent : function(){
        YYJK.DatePicker.superclass.initComponent.call(this);
...
Ext.reg('yyjk.datepicker', YYJK.DatePicker);