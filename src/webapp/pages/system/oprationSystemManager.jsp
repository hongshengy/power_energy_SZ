...
<html>
  <head>
	...
	<jsp:include page="/ext.jsp"/>
  	<script type="text/javascript" src="<%=basePath%>/pages/system/oprationSystemManager.js"></script>
  ...
  <body>
    <script>
		...
		Ext.onReady(function(){
			Ext.QuickTips.init();
			gdc.openModule(com.frontier.gdc.system.oprationSystemManager.newMainPanel,null,gdc.mdlCfg);
