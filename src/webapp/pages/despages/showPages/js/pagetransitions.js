...
var pageList = [
	'pages/despages/showPages/childPages/pageTwo.jsp',
    'pages/despages/showPages/childPages/pageOne.jsp',
//    'pages/despages/showPages/childPages/pageThree.jsp',
//    'pages/despages/showPages/childPages/pageFour.jsp',
    'pages/despages/showPages/childPages/pageFive.jsp'
];    
...
function autoSize(){
	var x = document.documentElement.clientWidth / 1920;
	var y = (document.documentElement.clientHeight) / 960;
	
	
	if (window.outerHeight === window.screen.height && window.outerWidth === window.screen.width){
		x = window.screen.width / 1920;
		y = window.screen.height / 960;
	}
	
	var popX = (x > y ? y : x);
	
	var marginWidth = (document.documentElement.clientWidth - (y*1920));
	var leftMargin = 0;
	if (marginWidth > 0){
	...
	$('#main_div').css({
		'transform': 'scale(' + popX + ')',
		'transform-origin' : 'left top',
		'margin-left' : leftMargin + 'px'
	});
	
	var iHeight = popX * 650;
	var iWidth = popX * 1000;
	var iTop = (popX * 150 + 10 * popX);
	var iLeft = popX * 450;
	var iBorderRadius = popX * 20;
	var iFontSize = popX * 24;
	$('#popWindow').css({
		'height' : iHeight + 'px',
		'width' : iWidth + 'px',
		'top' : iTop + 'px',
		'margin-left' : (iLeft + leftMargin) + 'px',
		'border-radius' : iBorderRadius + 'px',
		'font-size' : iFontSize + 'px'
	});
	
	var mHeight = popX * 550;
	var mWidth = popX * 900;
...
function onEndAnimation($outpage, $inpage, oldFameId) {
    ...
    if (subWeb == 'undefined' || subWeb != null){
    	subWeb.write('');
        subWeb.close();
    }
    canClick = true;
