        ...
        Ext.onReady(function(){
             $('#cxTab').tabs({    
				    ...
				    onSelect:function(title,index){
				        ...
				        if(index == 0){
				        	//var url = basePath+
					        //  "/pages/areaEnergy/baseData/userDataCenter/dlqxPic.jsp?LINEID="+lineId
					        //  +"&dateTime="+datadate;
				        	var url = basePath+
			          		"/pages/areaEnergy/baseData/userDataCenter/ssqxPic.jsp?LINEID="+lineId
				        ...
				        if(index == 1){
				        	var queryUrl = basePath+"/userDataCenterAction/ssqxData.action?"
				        	+"queryPara.LINE_ID="+lineId+"&queryPara.DATE_TIME="+datadate
				        	+"&queryPara.QUERY_TYPE=04&queryPara.QUERY_PARA=02&queryPara.startSize="+station;
