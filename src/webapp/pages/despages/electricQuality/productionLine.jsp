...
if(consId==null || consId.equals("")){//左侧树布局
	...
	session.setAttribute("itemCode","scxynpg");
	session.setAttribute("itemName","生产线用能评估");
%> 
...
<body class="easyui-layout" >
				...
				<div class="easyui-panel show-bottom-border" style="width: 100%;position: relative;" data-options="onResize:autoResize,border:false">
					<ul class="s-ul-one" >
						<li>
	                        ...
	                        <span class="tools-labelgroup" >
								<input id="dlzsEDateD"  class="Wdate" type="text" style="width: 130px;text-align: left;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,readOnly:true})" />
	...
	<script type="text/javascript" src="<%=baseUrl%>/pages/despages/electricQuality/productionLine.js"></script>	
