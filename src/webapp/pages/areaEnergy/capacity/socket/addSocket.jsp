...
<html>
	<head>
		...
		function doSubmit(result){
			if(result) {
				...
				$.ajax({
					url : des.webContextRoot +'capacity/insertSocket.action',
					type: "post",
					dataType:"text",
					data : para,
					timeout:60000, 
					...
					success : function(res) {
							if (res != "" && res != null) {
								 if(res == "exist"){
								 	//$.messager.confirm("提示","设备标识和端口已存在");
	    ...
	    // 画面合法性check
	  	function validateCheck() {
		     if($('#name').textbox('getValue') == "") {
		          $.messager.confirm("提示","插座名称不能为空，请输入");
		           return false;
		     }
    ...
    <body srolling='no'>
		<div id='queryDiv' class="container-shadow container-marginTop" style="width:100%;">
            <div class="easyui-panel" title="新增插座" style="width:100%;">
									...
									<table width="100%" cellspacing="8px" cellpadding="0"
										...
										<tr>
			                                ...
			                                <td >
			                                    ...
			                                    data-options="required:true,missingMessage:'请输入插座名称'"
			                                    >
			                             ...
			                             <tr>
			                                ...
			                                <td>
			                                	...
			                                	<input id="model" name="model" size="30" class="easyui-validatebox" validType="comboxValidate['model','请选择型号']" data-options="required:true">
											   	<font style="color: red;">*</font>
			                                </td>
			                             ...
			                             <tr>
			                                ...
			                                <td>
			                                	<input class="easyui-textbox" id="devAssetNo" size="30" data-options="required:true,missingMessage:'请输入设备标识'"/>
			                                   <font style="color: red;">*</font> 
			                                </td>
			                                <td class="td-label" align="right">端口号：</td>
			                                <td>
			                                	<input class="easyui-textbox" value="1" size="30" id="port" data-options="required:true,missingMessage:'请输入端口号'"/>
			                                </td>
			                             </tr>
			                             <tr>
											...
											<td>
												<input id="terminalAssetNo" type="text" size="30" editable='false' class="easyui-textbox" data-options="required:true,missingMessage:'请选择智能网关'">
