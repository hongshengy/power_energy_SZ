...
<html>
    ...
    <body srolling='no'>
		<div id='queryDiv' class="container-shadow container-marginTop" style="width:100%;">
            <div class="container-marginTop" style="position: absolute; top:70px; left:0; bottom: 0; right:0;">
	...
	function doEdit(){
		...
		$.each(rows,function(i,n){
			opener.$('#terminalNo').textbox('setValue',n.TMNL_ASSET_NO) ;
			opener.$('#terminalId').textbox('setValue',n.TERMINAL_ID) ;
			window.close();
        });
