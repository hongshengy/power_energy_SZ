											...
											<tr>
												...
												<td colspan="3" width="25%">
													<table>
														<tr>
															<td>
																<input id="areaNoCons" disabled="disabled" name="queryPara.areaNoCons"
																	size="27" >
																<font style="color: red;">*</font>
															</td>
														</tr>
...
<script type="text/javascript">
    ...
    //区域能源角色查询AreaNo和OrgNo
    function queryAreaOrgNo() {
    	$.ajax({
			type: "post",
			url: "<%=basePath%>" + 'capacityData/queryAreaOrgNo.action',
			dataType:"json",
			success: function(data) {
				var orgNo = data.rows[0].orgNo;
				var areaNo = data.rows[0].areaNo;
			    $("#org_no").val(orgNo);
			    $("#areaNo").val(areaNo);
			}
		});
