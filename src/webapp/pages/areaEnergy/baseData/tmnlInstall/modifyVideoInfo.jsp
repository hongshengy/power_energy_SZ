...
<html>
    ...
    <body srolling='no'>
		...
		<div id='queryDiv' class="container-shadow container-marginTop" style="width:100%;">
            <div class="easyui-panel" title="修改摄像头信息" style="width:100%;">
							...
							<td style="padding:5px;" width="100%">
									<table width="100%" cellspacing="8px" cellpadding="0"
										...
										<tr>
											...
											<td >
					                             <input type="text" size="18" id="installPlace" name="queryPara.installPlace" class="easyui-textbox" value="${resultMap.INSTALL_PLACE}"
											...
											<td>
												<input type="text" size="18" id="resolution" name="queryPara.resolution" class="easyui-textbox" value="${resultMap.RESOLUTION}"> 
											</td>
										...
										<tr>
											...
											<td >
					                             <input type="text" size="18" id="locationX" name="queryPara.locationX" class="easyui-textbox" value="${resultMap.LOCATION_X}">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												坐标Y
											</td>
											<td >
					                             <input type="text" size="18" id="locationY" name="queryPara.locationY" class="easyui-textbox" value="${resultMap.LOCATION_Y}">
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												坐标Z
											</td>
											<td >
					                             <input type="text" size="18" id="locationZ" name="queryPara.locationZ" class="easyui-textbox" value="${resultMap.LOCATION_Z}">
											</td>
										</tr>
										<tr>
											<td class="td-label" align="right" nowrap="nowrap">
											...
											<td colspan="3">
					                           <input class="easyui-textbox" data-options = 'multiline:true' name="queryPara.remark" id="remark" style= "width:490px;height:80px;" value="${resultMap.REMARK}">
											</td>
										</tr>
									</table>
							</td>
