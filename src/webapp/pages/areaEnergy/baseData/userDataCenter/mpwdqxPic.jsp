...
<script type="text/javascript">
		...
		function loadEchartPageByLine(){
			...
			var option = {
			    ...
			    legend: {
			        data:['母排温度U(A)相曲线','母排温度V(B)相曲线','母排温度W(C)相曲线'],
			        x: 'center',
			      	y:'bottom'
		...
		function loadData(){
			var queryparam = "queryPara.LINE_ID="+lineId+"&queryPara.DATE_TIME="+dateTime+"&queryPara.QUERY_TYPE=03&queryPara.QUERY_PARA=02&queryPara.startSize="+station;
			$.ajax({
				type: "post",
