...
<html>
	...
	<title>系统sql日志管理</title>
	<jsp:include page="/ext.jsp"/>
	<script type="text/javascript" src="<%= baseUrl%>/js/common/gridComponent.js"></script>
	<script type="text/javascript" src="<%= pagePath%>/sysSqlLog.js"></script>
	</head>
	<body>
	</body>
	<script type="text/javascript">
		gdc.openModule(com.frontier.gdc.system.sysSqlLog.newMainPanel,null,gdc.mdlCfg);
