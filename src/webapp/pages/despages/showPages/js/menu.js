...
function openNewsWin(newsId){
	var content = "<iframe src='"+basePath+"pages/despages/warn/newsNoticePop.jsp?newsId="+newsId+"' width='100%' height='99%' frameborder='0' scrolling='no'/>";
