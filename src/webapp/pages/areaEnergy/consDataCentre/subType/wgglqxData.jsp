		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th width="20%" align="center" data-options="field:'jxzgl'">总(kVar)</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">A相(kVar)</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">B相(kVar)</th>
					<th width="20%" align="center" data-options="field:'jxzgl'">C相(kVar)</th>
				</tr>
			</thead>
			<tbody>
