	...
	* {
	...
	<script type="text/javascript">
		 ...
		 function loadQydlBar(){
		    ...
		    +"&queryPara.ORG_NO=02&queryPara.TYPE=WO&queryPara.startSize="+station;
			document.getElementById("jcxtpFrame").src = basePath+"pages/areaEnergy/baseData/enviro/waterSensorPic.jsp?device="+device+"&data="+data+"&type=WO&station="+station;
	 	 	document.getElementById("jcxsjFrame").src = basePath+"/userDataCenterAction/waterSensorSou.action?"+queryparam;
		 }
