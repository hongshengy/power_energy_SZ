...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="<%=basePath2%>js/jquery.timers-1.1.2.js"></script>
	    <base href="<%=basePath2%>">
		<title>终端基本信息</title>
		<script type="text/javascript">
			 var fqrsPath = "http://10.134.78.59:81/aueic";
		</script>
	</head>
		   ...
		   <div id='view1' style="width: 100%; height: 150px;">
            ...
            <div id='view2' style="width: 100%;" >
	            <!--  <div id="cxTab" class="easyui-tabs" style="width:100%;">    -->
				     <!-- <div title="实时数据" id="cdsssj" style="display:none;">   
				    	<div id="view4">  -->
				        	<iframe id="fqrsFrame" width="100%" height="100%" frameborder="0" scrolling="no"></iframe> 
				      <!--    </div>
				   </div>    -->
				<!-- </div>  -->
			</div>
	...
	<script type="text/javascript">
		 //初始化方法
           $(document).ready(function(){
         	  ...
         	  document.getElementById("fqrsFrame").src = fqrsPath+"/areaEnergy/queryNilmList.action?queryPara.consNo="+'${queryPara.consNo}';
              //document.getElementById("fqrsFrame").src = basePath+"pages/areaEnergy/capacity/consData/znwgCdsssjTAB.jsp?terminalId="+terminalId+"&hheight="+hheight;
		 });
		 ...
		 function screen(){
			...
			$("#view2").height(dh-$("#view1").height()-5);
