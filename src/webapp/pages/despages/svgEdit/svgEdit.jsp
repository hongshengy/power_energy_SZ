...
/*         .query-panel table tr:last-of-type{
        ...
        #tool_newCircle{
            background: url('images/tubiao/tool_newCircle.png');
        }
        
        #tool_newRect{
            background: url('images/tubiao/tool_newRect.png');
        }
        ...
        #tool_downJd{
        	background: url('images/tubiao/tool_downJd.png');
        }
        
        #tool_leftJd{
        	background: url('images/tubiao/tool_leftJd.png');
        }
        
        #tool_rightJd{
        	background: url('images/tubiao/tool_rightJd.png');
        }
        
        #tool_leftDouble{
        	background: url('images/tubiao/tool_leftDouble.png');
        }
        
        #tool_rightDouble{
        	background: url('images/tubiao/tool_rightDouble.png');
        }
        
        #tool_dianqi1{
        	background: url('images/tubiao/tool_dianqi1.png');
        }
        
        #tool_dianqi2{
        	background: url('images/tubiao/tool_dianqi2.png');
        }
        
        #tool_dianqi3{
        	background: url('images/tubiao/tool_dianqi3.png');
        }
        
        #tool_dianqi4{
        	background: url('images/tubiao/tool_dianqi4.png');
        }
        
        #tool_dianqi5{
        	background: url('images/tubiao/tool_dianqi5.png');
        }
        
        #tool_juxingjiantou{
        	background: url('images/tubiao/tool_juxingjiantou.png');
        }
		...
		.wordLeft:hover {
			...
			position:relative;
			left:4px;
     		background: url(images/flushLeftHover.png) 0px 0px no-repeat;
		 }
		.wordRight {
			width:18px;
			height:18px;
		...
		.wordRight:hover {
			...
			position:relative;
			left:4px;
     		background: url(images/flushRightHover.png) 0px 0px no-repeat;
		 }
		.wordMiddle {
			width:18px;
			height:18px;
		 ...
		 .wordMiddle:hover {
			...
			position:relative;
			left:4px;
     		background: url(images/flushMiddleHover.png) 0px 0px no-repeat;
		 }
/* table.common-table{
                ...
                <div class="content">
                    <div class="accordion-panel" data-options="multiple:true,border:false">
                        <div title="开关设备">
                            ...
                            <div class="buttons-row">
                                <span id="tool_newCircle" class="my_tool_button" title="工况1"></span>
                                <span id="tool_newRect" class="my_tool_button" title="工况2"></span>                                
                            </div>
                        </div>
                        <div title="环境设备">
                            <div class="buttons-row">
                        ...
                        <div title="电器设备">
                            ...
                            <div class="buttons-row">
                            	<span id="tool_downJd" class="my_tool_button" title="接地"></span> 
                                <span id="tool_leftJd" class="my_tool_button" title="接地"></span>
                                <span id="tool_rightJd" class="my_tool_button" title="接地"></span> 
                            </div>
                            <div class="buttons-row">
                            ...
                            <div class="buttons-row">
                                ...
                                <span id="tool_leftDouble" class="my_tool_button" title="左双箭头"></span> 
                                <span id="tool_rightDouble" class="my_tool_button" title="右双箭头"></span>                                                               
                            </div>
                            <div class="buttons-row">
                                <span id="tool_JTinRect" class="my_tool_button" title="矩形里箭头"></span>
                                <span id="tool_juxingjiantou" class="my_tool_button" title="矩形箭头"></span> 
                                <span id="tool_rightJT" class="my_tool_button" title="向右箭头"></span>                               
                            </div>                           
                            <div class="buttons-row">
                                <span id="tool_dianqi1" class="my_tool_button" title="电器1"></span> 
                                <span id="tool_dianqi2" class="my_tool_button" title="电器2"></span> 
                                <span id="tool_dianqi3" class="my_tool_button" title="电器3"></span>                                                              
                            </div>
                            <div class="buttons-row">
                                <span id="tool_dianqi4" class="my_tool_button" title="电器4"></span> 
                                <span id="tool_dianqi5" class="my_tool_button" title="电器5"></span> 
    ...
    <div class="right-panel">
        <div class="query-panel item-row">
            <table class="form-table">
                ...
                <tr>
                    <td>用户变：</td>
                    <!-- <td><input class="easyui-combobox-lazyLoad"></td> -->
                    <!-- <td><select id="subSelectCtl" class="easyui-combotree" style="width:150px"></select></td> -->
                    <td class="td-value"><span class="toggleUser-link" id="subSelectCtl" ></span><input type="text" id="subsIdSelect" class="hidden"></td></td>
                </tr>
                <tr>
                    <td>一次图：</td>
                    <!-- <td><input id="yicitu-combobox"></td> -->
                    <td><select id="svgSelectCtl" class="easyui-combotree" style="width:150px" ></select>
                ...
                <tr>
                    <td colspan="4">
                        <a id="uploadSvgBtn" href="#" class="easyui-linkbutton c9 shadow" style="width:120px">上传一次图</a>
                ...
                <tr>
                	<td colspan="4">
                		<label><input type="checkbox" id="setIntalSave">自动保存</label>
                		<label>
                		<select id="minSelectCtl"  class="easyui-combobox"  style="width:100px">
        ...
        <div class="item-row row6">
            <table class="form-table">
                ...
                <tr>
                    ...
                    <a href="#" class="easyui-linkbutton c9 shadow" id="DeleteMpAll" style="width:100px">删除测点配置</a>
                    </td>
                </tr>
                </tbody>
            </table>
...
<!-- 确定删除弹出层 -->
<!-- <div id="divDelete">
	<div class="content" style="height:115px;width:350px;height:100px;line-height:100px;text-align:center">
	<tr>
        <td class="easyui-textbox-lazyLoad">确定删除吗？</td>
    </tr>	
	</div>
	<div id="button1" style="text-align: center;">
        <a href="#"  id="DeleteSub" class="easyui-linkbutton c9 shadow" style="width: 80px">保存</a>
        <a href="#"  id="QuitDeleteSub" class="easyui-linkbutton c9 shadow" style="width: 80px">取消</a>
    </div>
</div> --> 
...
<!-- <div id="divUpload">
	...
	<div id="button3" style="text-align: center;">
        <a href="#"  id="UploadSub" class="easyui-linkbutton c9 shadow" style="width: 80px">保存</a>
        <a href="#"  id="QuitSub" class="easyui-linkbutton c9 shadow" style="width: 80px">取消</a>
    </div>
</div> -->
<script type="text/javascript">var basePath = '<%=basePath%>';
<%-- alert("unionId:     "+unionId);
var consName =unescape('<%=consName%>');
alert(consName);  
var userTranId = '<%=userTranId%>'; 
var subsName = unescape('<%=subsName%>'); 
alert("subsName:     "+subsName);
var svgId = '<%=svgId%>'; 
var svgName = unescape('<%=svgName%>');  --%>
</script>
<script type="text/javascript" src="jquery.js"></script>
<script type="text/javascript" src="svgEdit/draw_tubiao.js"></script>
...
<script src="<%=basePath%>/pages/despages/svgEdit/svgEdit1.js" type="text/javascript"></script> 
</body>
