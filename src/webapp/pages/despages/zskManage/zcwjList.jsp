...
height:10px;
	...
	<div class="main-panel noOverflow" data-options="region:'center',border:false" >
		<div id="divSearch" class="easyui-panel" style="width: 100%;position: relative;" title="查询条件" data-options="cls:'fangtian-panel-style',onResize:autoResize">
			<ul class="s-ul-one" >
				...
				<li>
				    <span>具体来源：</span>
				    <input id="xxly_lynr" class="easyui-combobox"  name="xxly_lynr" data-options="editable:false,panelWidth:155" style="height:24px;width:155px"></input>
				</li>
				<li>
				    <span>政策名称：</span>
		...
		<div id="c-panel" class="auto-resize easyui-panel" style="width: 100%;" data-options="cls:'fangtian-panel-style bottom-padding'">
			...
			<!--内容区域（表格、图表等）-->
			<div id="zcwj"  title="政策文件"></div>
		</div>
	</div>
	
	<div class="easyui-panel" style="width:100%;height:90%" border="false" data-options="cls:'fangtian-panel-style'">
			<table id="zcwj" cellspacing="0"></table>
	</div>
	<div id="zcfgxz" class="easyui-window" closed="true" modal="true" title="新增" style="display: none"
		...
		<s:form id="xzform">
				<table class="formTable" style="margin:10px 20px 0px 20px" align="center">
					<tr>
						<td class="div-label">政策名称：</td>
						<td colspan="3">
							<input class="easyui-textbox"  name="xz_name"   id="xz_name"style="height:24px;width:400px"required="true" data-options="required:true,validType:'length[1,60]'">
							<s:hidden name="id" />
						</td>
					</tr>
					<tr>
			            <td class="div-label">政策来源：</td>
			            <td>
			            	  <input class="easyui-combobox" name="zcfg_xxly1" id="zcfg_xxly1" style="width:120px;" data-options="editable:false,panelWidth:120"required="true"></input>
			   
			            </td>
			            <td class="div-label">具体来源：</td>
			             <td align="right">
			            	<input class="easyui-combobox" name="xxly_lynr1" id="xxly_lynr1" style="width:120px;" data-options="editable:false,panelWidth:120" required="true"></input>
			       
			            </td>
					</tr>
					<tr>
						<td class="div-label">政策内容：</td>
						<td colspan="3">
				...
				<table align="center">
					<tr>
						...
						<td><a href="#" class="easyui-linkbutton shadow" 
	                                    id="xz_zcwjUpload" style="width: 90px; height: 45px; vertical-align: 0;">上传</a></td>
						<td><div id="xz_zcwjFile" style="width: 213px; height: 45px; vertical-align: 0;"></div></td>
	...
	<div id="zcfgck" class="easyui-window" closed="true" modal="true" title="政策文件详情" style="display: none"
		 data-options="minimizable:false,maximizable:false,collapsible:false,resizable:true,modal:true,closed:true">
		...
		<s:form id="ckform" enctype="multipart/form-data" method="post">
				<table class="formTable">
					...
					<tr>
			            ...
			            <td class="div-label">具体来源：</td>
			            <td align="right">
			            	<input class="easyui-textbox" name="xxly_lynr2" id="xxly_lynr2" style="width:120px;" readonly="true"></input>
			            </td>
					</tr>
					<tr>
						<td>
		 ...
		 data-options="minimizable:false,maximizable:false,collapsible:false,resizable:true,modal:true,closed:true">
					...
					<table class="formTable" style="margin:10px 20px 0px 20px" align="center">
						<tr>
							...
							<td colspan="3">
								<input class="easyui-textbox"  name="xg_name"   id="xg_name"style="height:24px;width:400px" data-options="required:true,validType:'length[1,60]'">
								<s:hidden name="id" />
							</td>
						</tr>
						<tr>
				            <td class="div-label">法规来源：</td>
				            <td>
				            	  <input class="easyui-combobox" name="zcfg_xxly3" id="zcfg_xxly3" style="width:120px;"  data-options="required:true,editable:false,panelWidth:120"></input>
				   
				            </td>
				            <td class="div-label">具体来源：</td>
				      	      <td align="right">
				            	<input class="easyui-combobox" name="xxly_lynr3" id="xxly_lynr3" style="width:120px;"  data-options="required:true,editable:false,panelWidth:120"></input>
			        ...
			        <!-- <div class="fujian" align="center">
						<table align="center">
								<tr>
									<td class="div-label">文件上传：</td>
									<td><a href="#" class="easyui-linkbutton shadow" 
				                                    id="xg_zcwjUpload" style="width: 90px; height: 45px; vertical-align: 0;">上传</a></td>
									<td><div id="xg_zcwjFile" style="width: 213px; height: 45px; vertical-align: 0;"></div></td>
									<td><a href="#" class="easyui-linkbutton shadow cancelUpload" 
				                                    id="" style="width: 90px; height: 45px; vertical-align: 0;">取消上传</a></td>
								</tr>
						</table>
...
<script type="text/javascript" src="zcwjList.js"></script>
