...
// 			        }
		...
		function loadData(){
			var queryparam = "queryPara.LINE_ID="+lineId+"&queryPara.DATE_TIME="+dateTime+"&queryPara.QUERY_PIC=01&queryPara.QUERY_PARA=01&queryPara.startSize="+station;
			$.ajax({
				type: "post",
