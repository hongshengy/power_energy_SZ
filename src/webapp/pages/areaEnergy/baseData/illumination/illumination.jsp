...
<html>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
        	...
        	//默认显示 
            document.getElementById("jcxsjFrame").src = basePath+"pages/areaEnergy/baseData/illumination/illuminationTab.jsp?device="+device+"&data="+searchrq+"&station="+station;
            //下拉框触发改变事件
			$("#searchmc").combobox({
				onChange:function(newValue,oldValue){
					parent.document.getElementById("rightFrame").src = basePath+"areaEnergy/queryIllumNation.action?queryPara.subId="+subId+"&queryPara.id="+newValue+"&queryPara.other="+other+"&queryPara.isdevice="+isdevice;
