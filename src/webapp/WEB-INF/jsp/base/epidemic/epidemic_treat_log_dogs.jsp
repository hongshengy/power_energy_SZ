                ...
                <%--<div id="headDiv" class="row">--%>
                    ...
                    <%--<div class="col-sm-7">--%>
                        ...
                        <%--<div id="ill_Date" class="row" needAppend="true">--%>
                            ...
                            <%--</div>--%>
                        <%--</div>--%>
                        <%--<div id="hospital_Id" class="row" needAppend="true">--%>
                            <%--<div class="col-sm-2">--%>
                                <%--<label>看病医院</label>--%>
                            <%--</div>--%>
                            <%--<div class="col-sm-1">:</div>--%>
...
<script type="text/javascript">
    ...
    var pageDataSql = 'EpidemicTreatLogDogsMapper.getListByParamsByPage';
    ...
    //    添加
    function add() {
        layerOpenFn('${showPagePath}','添加看病记录','base/epidemic/epidemic_treat_log_dogsPage',bodyW-100, bodyH);
    }

    function editFun(id) {
        parentParams = id;
        layerOpenFn('${showPagePath}','编辑看病记录','base/epidemic/epidemic_treat_log_dogsEditPage',bodyW-100, bodyH);
    }
    ...
    function delFun(id) {
        ...
        layerConfirm('确认删除？',['确认','取消'],[function () {
            getDataFnNoErrorF(
                deleteDataPath
                , {sql:'EpidemicTreatLogDogsMapper.deleteInfo',id:id}
                , function (data) {
    ...
    $('#btn_export').click(function () {
        var mmm = ['看病医院','检疫犬名','病历说明','看病日期','','记录时间','',''];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=EpidemicTreatLogDogsMapper.selectInfo&fileName=看病记录管理&titleParams='+titleParams);
    });
</script>
<%--导航--%>
