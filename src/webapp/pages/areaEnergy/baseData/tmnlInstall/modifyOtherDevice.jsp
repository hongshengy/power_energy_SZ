...
<html>
    ...
    <body srolling='no'>
		...
		<div id='queryDiv' class="container-shadow container-marginTop" style="width:100%;">
            <div class="easyui-panel" title="修改设备" style="width:100%;">
							...
							<td style="padding:5px;" width="100%">
									<table width="100%" cellspacing="8px" cellpadding="0"
										...
										<tr>
											...
											<td width="25%">
												<input type="text" size="18" id="deviceNo" name="queryPara.deviceNo" class="easyui-textbox" value="${resultMap.DEVICE_NO}"
                                            ...
                                            <td width="25%">
												 <input type="text" size="18" id="deviceName" name="queryPara.deviceName" class="easyui-textbox" data-options="required:true,missingMessage:'请选择设备名称'" value="${resultMap.DEVICE_NAME}">
												 <font color="red">&nbsp;&nbsp;*</font>
											</td>
											<td class="td-label" align="right"  nowrap="nowrap">
                                              	 设备分类
                                            ...
                                            <td width="25%">
					                            <input size="18" id="deviceType1" name="queryPara.deviceType1">
                                            </td>
										</tr>
										<tr>
                                            <td class="td-label" align="right" nowrap="nowrap">
											...
											<td width="25%">
					                            <input id="factoryCode" name="queryPara.factoryCode" size="18">
											</td>
											<td class="td-label" align="right"  nowrap="nowrap">
                                                 	出厂日期
                                            </td>
                                            <td width="25%">
                                                  <input type="text" class="easyui-datebox" data-options="width:140" id="madeDate" name="queryPara.madeDate" value="${resultMap.MADE_DATE}"/>
                                            </td>
                                            <td class="td-label" align="right" nowrap="nowrap">
												运行状态
											</td>
											<td width="25%">
					                            <input id="runStatus" name="queryPara.runStatus" size="18">
											</td>
										</tr>
										<tr>
											<td class="td-label" align="right" nowrap="nowrap">
											...
											<td width="25%">
					                            <input type="text" class="easyui-datebox" data-options="width:140" id="createDate" name="queryPara.createDate" value="${resultMap.CREATE_DATE}"/>
											</td>
											<td class="td-label" align="right" nowrap="nowrap">
												是否电气设备
											</td>
											...
											<td>
												<input class="easyui-textbox" size="18" readonly="readonly" name="queryPara.tmnlAssetNo" id="tmnlAssetNo" data-options="required:true,missingMessage:'请选择所属终端'" value="${resultMap.TMNL_ASSET_NO}">
										...
										<tr>
											...
											<td colspan="5">
					                           <input class="easyui-textbox" data-options = 'multiline:true' value="${resultMap.REMARK}" name="queryPara.remark" id="remark" style= "width:470px;height:80px;">
											</td>
										</tr>
									</table>
							</td>
