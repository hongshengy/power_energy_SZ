...
<body style="overflow:hidden;height: 100%;width: 100%; ">
	<div style="height: 100%;width: 100%;">
		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					<th width="10%" align="center" data-options="field:'timeData'">数据时间</th>
					<th width="15%" align="center" data-options="field:'jxzgl1'">AB相电压(V)</th>
					<th width="15%" align="center" data-options="field:'jxzgl2'">BC相电压(V)</th>
					<th width="15%" align="center" data-options="field:'jxzgl3'">CA相电压(V)</th>
					<th width="15%" align="center" data-options="field:'jxzgl4'">A相电压(V)</th>
					<th width="15%" align="center" data-options="field:'jxzgl5'">B相电压(V)</th>
					<th width="15%" align="center" data-options="field:'jxzgl6'">C相电压(V)</th>
				</tr>
			</thead>
			<tbody>
					...
					<tr>
							...
							<td>${data.TAB_VALUE}</td>
							<td>${data.TBC_VALUE}</td>
							<td>${data.TCA_VALUE}</td>
							<td>${data.TA_VALUE}</td>
							<td>${data.TB_VALUE}</td>
							<td>${data.TC_VALUE}</td>
					</tr>
