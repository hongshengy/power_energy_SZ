...
<script type="text/javascript">
		...
		function loadData(){
			var queryparam = "queryPara.LINE_ID="+lineId+"&queryPara.DATE_TIME="+dateTime+"&queryPara.QUERY_TYPE=04&queryPara.QUERY_PARA=02&queryPara.startSize="+station;
			$.ajax({
				type: "post",
				url: "<%=basePath%>/userDataCenterAction/ygwgysPublicUtilQueryInfo.action",
				data : queryparam,
				dataType : "json",
				cache : false,
				async : false,//同步异步请求
				success : function(result) {
					...
					xNameLineTime = result.X_DATA1;
					xNameLineTime1 = result.X_DATA2;
					xNameLineTime2 = result.X_DATA3;
					xNameLineTime3 = result.X_DATA4;
