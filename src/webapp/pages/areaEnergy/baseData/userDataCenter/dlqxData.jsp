		...
		<table id="tableDD" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th width="25%" align="center" data-options="field:'jxzgl1'">电流U(A)相曲线(A)</th>
					<th width="25%" align="center" data-options="field:'jxzgl2'">电流V(B)相曲线(A)</th>
					<th width="25%" align="center" data-options="field:'jxzgl3'">电流W(C)相曲线(A)</th>
				</tr>
			</thead>
			<tbody>
