...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function() {
				var gridH = $(window).height()-$('#subDiv').height()-$('#queryDiv').height()-10;
				if(gridH<200){
				   gridH = 200;
				}
				$('#surveyTable').datagrid({
					...
					fitColumns: true, 
					url : '<%=basePath %>capacityData/querySocketMp.action',
					queryParams : {"queryPara.deviceId":'${id}',"queryPara.dataDate" : $("#dataDate").val(), "queryPara.mpType":$("#mpType").val()},
					sortOrder : 'desc',
					remoteSort : false,
					showFooter : true,
					pageSize : 50,
					...
					<tr>
						<td style="padding:5px;" width="100%">
							<fieldset
								...
								<legend>
									<font style="font-size: 12px; font-weight: bold;">智能插座</font>
								</legend>
