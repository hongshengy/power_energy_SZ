...
<html>
    ...
    <body srolling='no'>
		...
		<input type='hidden' id='tmnl' name='tmnlAssetNo' value="${param.tmnlId }">
		<input type='hidden' id='deviceId' name='deviceId' value="${param.deviceId}">
				                ...
				                success : function(result) {
				                     if(result.flag=='1'){
			         					$.messager.alert('提示',result.msg,'info',function(){
			      						...
			      						$.each(rows,function(i,n){
		         				        	opener.$('#terminalId').textbox('setValue',n.TMNL_ASSET_NO) ;
		         				    		opener.$('#tmnlAssetNo').attr('value',n.TERMINAL_ID) ;
		         				    		window.close();
		         				    	});
			      					}
				                }
