...
<script type="text/javascript">
    ...
    getDataFnNoErrorF(
        dataPath
        , {sql: 'RoleInfoMapper.selectOneInfo', id: selectRowData['id']}
        , function (data) {
            if (null != data[0] && '' != data[0]) {
                appendData(data[0]['RoleInfoMapper.selectOneInfo'][0]);
            }
        }
        , function (data) {
    ...
    $.validator.setDefaults({
        submitHandler: function () {
            getDataFnNoErrorF(
                ...
                , function (data) {
                    if (data[0]['RoleInfoMapper.getCountByParams'][0]['COUNT'] > 0 && data[0]['RoleInfoMapper.getCountByParams'][0]['id'] != selectRowData['id']) {
                        ...
                        layerConfirm('确认修改？', ['确认', '取消'], [function () {
                            getDataFnNoErrorF(
                                updateDataPath
                                , $('#formSearch').serialize() + '&sql=RoleInfoMapper.updateinfo&id=' + selectRowData['id']
                                , function (data) {
