        ...
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                <div class="form-group" style="margin-top:15px">
                    <label class="control-label col-sm-1" for="goods_purchase_Content">备注</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="goods_purchase_Content" name="goods_purchase_Content">
                    </div>
...
<script type="text/javascript">
    ...
    var pageDataSql = 'GoodsPurchaseInfoMapper.getListByParamsByPage';
    ...
    var columns = [
        {
            ...
            field: 'goods_purchase_Content',
            title: '备注'
        }, {
            field: 'ZHUANGTAI',
            title: '物资采购状态'
        }, {
            field: 'goods_purchase_Statuc',
            title: '物资采购状态'
        }, {
            field: 'create_date',
            title: '采购信息创建时间',
...
//            offset: params.offset,                  //页码
            goods_purchase_Content: $("#goods_purchase_Content").val(),
    ...
    $('#tb_departments').bootstrapTable('hideColumn', 'goods_purchase_Statuc');     //隐藏需替换的列
    ...
    //    添加
    function add() {
        layerOpenFn('${showPagePath}', '添加采购物资', 'base/goods/goods_purchaseinfoPage', bodyW - 100, bodyH);
    }

    //    修改
    function edit() {
        if ($('#tb_departments').bootstrapTable('getSelections').length == 1) {
            layerOpenFn('${showPagePath}', '编辑采购物资', 'base/goods/goods_purchaseinfoEditPage', bodyW - 100, bodyH);
        } else {
    ...
    //    删除
    function deleteFun() {
        sysDeleteFun('GoodsPurchaseInfoMapper.deleteInfo');
    }

    //    导出
    $('#btn_export').click(function () {
        var mmm = ['备注','库房名称','物资采购状态','采购人','','采购数量','','','采购时间','','采购总价','物资名称','','采购信息创建时间','系统录入时间','物资类型名称'];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=GoodsPurchaseInfoMapper.selectInfo&fileName=物资采购管理&titleParams='+titleParams);
    });
</script>
