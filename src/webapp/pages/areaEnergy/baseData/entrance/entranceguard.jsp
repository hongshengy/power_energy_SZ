...
<html>
					...
					<tr>
						<td style="padding: 5px;" width="100%">
							<fieldset
								...
								<legend>
									<font style="font-size: 12px; font-weight: bold;">门禁设备</font>
								</legend>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
        	...
        	//默认显示 
            document.getElementById("Frame4").src = basePath+"pages/areaEnergy/baseData/entrance/entranceGuardTab.jsp?device="+device+"&data="+searchrq+"&station="+station+"&tabSign="+tabSign;
            //下拉框触发改变事件
			$("#searchmc").combobox({
				onChange:function(newValue,oldValue){
					parent.document.getElementById("rightFrame").src = basePath+"areaEnergy/queryEntranceGuard.action?queryPara.subId="+subId+"&queryPara.id="+newValue+"&queryPara.other="+other+"&queryPara.isdevice="+isdevice;
				} 
			});
		 });
