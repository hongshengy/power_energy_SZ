    ...
    <link rel="stylesheet" type="text/css"
        ...
        <script type="text/javascript">
					...
					toolbar : [
						{
							...
							handler : function() {
								...
								var url="<%=basePath %>/pages/areaEnergy/baseData/consInfo/consSub.jsp?areaNo=101&roleCode="+roleCode+"&consId="+consId+"&voltCode="+voltCode;
			...
			function modifyTmnlInfo(saveFlag){
			   ...
			   $("#USER_CODE").combobox({disabled:saveFlag});
			...
			function doSave(result){
				if(result) {
					  ...
					  "&TRADE_CODE="+$('#TRADE_CODE').combobox('getValue')+"&USER_CODE="+$('#USER_CODE').combobox('getValue');
					$.ajax({
		    ...
		    <div title="电力客户" style="">  
		        <div id="consDiv" class="easyui-panel" title="客户信息" style="border: 0; height:570px; width:100%;overflow: auto; background: #fafafa;padding:0">
				  <form id="thisform" method="post">
				    ...
				    <input id="areaNo" type="hidden" name="queryPara.areaNo" value="">
									...
									<table style="width: 100%;" border="0">
										<tbody>
											...
											<tr>
												...
												<td>
													<input id="USER_CODE" name="queryPara.USER_CODE" value="${resultMap.USER_CODE}"
														size="27" >
												</td>
												<td class="td-label" align="center">
												</td>
...
<script type="text/javascript">
    $( function() {
        ...
        $('#USER_CODE').combobox({
           	url :'<%=basePath%>areaEnergyTmnl/getUserCode.action',
