...
<div class="panel-body" style="padding:5px;">
    <div class="panel panel-default">
        <div class="panel-heading">检疫犬日常体检管理</div>
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                <div class="form-group" style="margin-top:15px">
                    <label class="control-label col-sm-1" for="dog_Name">犬名</label>
                    <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    var pageDataSql = 'PhysicalExaminationInfoMapper.getListByParamsByPage';
...
//    $('#tb_departments').bootstrapTable('hideColumn', 'treat_Status');     //隐藏需替换的列
...
//    添加
    function add() {
        layerOpenFn('${showPagePath}','添加检疫犬日常体检','base/epidemic/epidemic_physical_examinationPage',bodyW-100, bodyH);
    }

    //    修改
    function edit() {
        if($('#tb_departments').bootstrapTable('getSelections').length == 1){
            layerOpenFn('${showPagePath}','编辑检疫犬日常体检', 'base/epidemic/epidemic_physical_examinationEditPage', bodyW-100, bodyH);
        }else {
    ...
    //    删除
    function deleteFun() {
        sysDeleteFun('PhysicalExaminationInfoMapper.deleteInfo');
    }

    //    导出
    $('#btn_export').click(function () {
        var mmm = ['检疫犬名','','体检日期','精神状态','状况'];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=PhysicalExaminationInfoMapper.selectInfo&fileName=检疫犬日常体检管理&titleParams='+titleParams);
    });
</script>
