...
<html>
    ...
    <input type = 'hidden' id="consNo" value="<%=consNo%>"/>
		<div id="line1"style="background-color: white; border: 0px solid #ccc; margin: 0px; width: 1000px;height:500px;">
				       </div>
	</body>
...
function query(){
		...
		if(!time){
			...
			$.ajax({
				type: "post",
				url: "<%=basePath%>/fqrsTmnl/generalElecUsedView.action?queryPara.flag=1&queryPara.date="+$('#dataDate').val()+"&queryPara.consId="+$('#consId').val(),
				dataType:"json",
