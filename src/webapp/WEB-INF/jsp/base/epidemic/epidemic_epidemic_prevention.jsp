...
<div class="panel-body" style="padding:5px;">
    <div class="panel panel-default">
        <div class="panel-heading">疫病防治库管理</div>
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                <div class="form-group" style="margin-top:15px">
                    <label class="control-label col-sm-1" for="epidemic_Name">疫病名称</label>
                    <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    var pageDataSql = 'EpidemicPreventionInfoMapper.getListByParamsByPage';
    ...
    var columns = [
        {
            ...
            formatter: function (value, row, index) {
                var value2 = getLocalDate(value.time);
                return value2;
            }
        }, {
            field: 'therapeutic_Regimen',
            title: '治疗方案'
        }, {
...
//            user_Name: $("#user_Name").val(),
            epidemic_Name: $("#epidemic_Name").val(),
    ...
    $('#tb_departments').bootstrapTable('hideColumn', 'epidemic_Type');     //隐藏需替换的列
...
//    添加
    function add() {
        layerOpenFn('${showPagePath}','添加疫病防治库','base/epidemic/epidemic_epidemic_preventionPage',bodyW-100, bodyH);
    }

    //    修改
    function edit() {
        if($('#tb_departments').bootstrapTable('getSelections').length == 1){
            layerOpenFn('${showPagePath}','编辑疫病防治库', 'base/epidemic/epidemic_epidemic_preventionEditPage', bodyW-100, bodyH);
        }else {
    ...
    //    删除
    function deleteFun() {
        sysDeleteFun('EpidemicPreventionInfoMapper.deleteInfo');
    }

    //    导出
    $('#btn_export').click(function () {
        var mmm = ['治疗效果','疫病名称','疫病种类','发现日期','','','治疗方案'];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=EpidemicPreventionInfoMapper.selectInfo&fileName=疫病防治库管理&titleParams='+titleParams);
    });
</script>
