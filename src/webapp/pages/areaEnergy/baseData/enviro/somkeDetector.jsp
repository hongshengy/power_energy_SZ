	...
	* {
	...
	<script type="text/javascript">
		 ...
		 function loadQydlBar(){
		    ...
		    +"&queryPara.ORG_NO=02&queryPara.TYPE=SF&queryPara.startSize="+station;
			document.getElementById("jcxtpFrame").src = basePath+"pages/areaEnergy/baseData/enviro/somkeDetectorPic.jsp?device="+device+"&data="+data+"&type=SF&station="+station;
	 	 	document.getElementById("jcxsjFrame").src = basePath+"/userDataCenterAction/somkeDetectorSou.action?"+queryparam;
		 }
