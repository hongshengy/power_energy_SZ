...
<script type="text/javascript">
    ...
    getSelectDataByIdObject.sql = 'DemandPlanningInfoMapper.selectInfo';
    ...
    function subData() {
        ...
        layerConfirm('确认提交？', ['确认', '取消'], [function () {                                                //**************
            ...
            getDataFnNoErrorF(                                                                                  //↓
                updateDataPath                                                                                  //↓
                , $('#formSearch').serialize() + '&sql=DemandPlanningInfoMapper.updateInfo&id=' + selectRowData['id']    //↓
                , function (data) {                                                                             //↓
                    if (null != data) {                                                                         //↓
                        parent.query(1, 10);                                                                    //↓
                        parent.layer.closeAll();                                                                //↓
