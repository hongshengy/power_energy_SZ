        ...
        if (isValid){
			$.messager.confirm('确认','您确认想要保存记录吗？',function(r) {
								if (r) {
									$.messager.progress();
									$('#ff').form('submit',{
									url :'<%=basePath%>areaEnergyTmnl/modifyFlashServerInfo.action',    
								    success:function(res){    
								        ...
								        if (res != "" && res != null) {
			                                if (res == "wrong"){
	                                            ...
	                                            $.messager.alert('警告','连接IP地址已存在！');
	                                        }else if (res == "ok"){
			                                    window.opener.parent.com.frontier.areaEnergy.baseData.reloadTree.flushAndClickCurrentNode();
			                                    window.close();
			                                }
		                                }
										...
										<tr>
											...
											<td width="25%">
												<input id="rvuMadeCompany" name="queryPara.rvuMadeCompany"
													value="${resultMap.RVU_MADE_COMPANY}" size="27"validType="comboxValidate['rvuMadeCompany','请输入生产厂家名称']">
												<font style="color: red;">*</font>
											</td>
											<td class="td-label" align="center" nowrap="nowrap">
												通道数量
											...
											<td width="25%">
                                                <input id="rvuChannel"
                                                    ...
                                                    class="easyui-numberbox"value="${resultMap.RVU_CHANNEL}"
										...
										<tr>
											...
											<td width="25%">
												<input id="rvuIp"
													...
													class="easyui-textbox"value="${resultMap.RVU_IP}"
											...
											<td width="25%">
                                                <input id="rvuPort"
                                                    ...
                                                    class="easyui-numberbox"value="${resultMap.RVU_PORT}"
											...
											<td width="25%">
                                                <input id="commProtCode" name="queryPara.commProtCode" value="${resultMap.COMM_PROT_CODE}"
										...
										<tr>
											...
											<td width="25%">
                                                <input id="loginName" name="queryPara.loginName"
                                                    size="27" class="easyui-textbox"value="${resultMap.LOGIN_NAME}"
											...
											<td width="25%">
                                                <input id="loginPass" name="queryPara.loginPass" type="password"
                                                    size="27" class="easyui-textbox"value="${resultMap.LOGIN_PASS}"
											...
											<td width="25%">
                                                <input id="diskCapacity"
                                                    ...
                                                    class="easyui-numberbox"value="${resultMap.DISK_CAPACITY}"
										...
										<tr>
											...
											<td colspan="3" width="25%">
												<input id="installPlace"
                                                    name="queryPara.installPlace"value="${resultMap.INSTALL_PLACE}"
										...
										<tr>
											...
											<td colspan="5">
												<input class="easyui-textbox" multiline="true" id="remark"
													name="queryPara.remark" value="${resultMap.REMARK }" data-options="validType:'length[1,64]'"
													style="width: 100%; height: 120px">
											    <input type="hidden" value="${resultMap.REMARK }" id="remark_bak"/>
											</td>
										</tr>
									</tbody>
								</table>
