                	...
                	<ul class="s-ul-one">
                		<li id="selectTime">
							...
							<!-- <input id="endDate" class="easyui-datetimebox"  style="height:24px;width:150px" data-options="editable:false,panelWidth:150"/> -->
							  <input id="endDate" class="Wdate" type="text" style="height:24px;width: 155px;text-align: left;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})"/>
                		</li>
	 	 ...
	 	 data-options="minimizable:false,maximizable:false,collapsible:false,resizable:true,modal:true,closed:true">
				<table class="formTable" style="margin:10px 20px 20px 20px" align="center">
					...
					<tr>
						...
						<td >
							<input class="easyui-textbox" name="contactWay" id="contactWay" style="width:140px;" data-options="editable:true,panelWidth:110,validType:['telephone']"required="true"></input>
						</td>
						<td >
					...
					<tr>
						...
						<td colspan="3">
							<input class="easyui-textbox"  name="subject" id="subject" class="easyui-validatebox" 
								required="true" style="width:400px; height:100px;" validType="length[0,80]" data-options="multiline:true"></input> 
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<input class="easyui-textbox"  name="applyMemo" id="applyMemo" class="easyui-validatebox" 
								required="true" style="width:400px; height:100px;" validType="length[0,160]" data-options="multiline:true"></input> 
						</td>
					</tr>
				</table>	
...
</script><script type="text/javascript" src="hdbd.js"></script> 
</body>
</html>
