...
<div class="panel-body" style="padding:5px;">
    <div class="panel panel-default">
        <div class="panel-heading">动物医院管理</div>
        <div class="panel-body">
            <form id="formSearch" class="form-horizontal">
                <div class="form-group" style="margin-top:15px">
                    <label class="control-label col-sm-1" for="hospital_Name">医院名称</label>
                    <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    var pageDataSql = 'EpidemicZooHospitalMapper.getListByParamsByPage';
...
//    添加
    function add() {
        layerOpenFn('${showPagePath}','添加动物医院','base/epidemic/epidemic_zoo_hospitalPage',bodyW-100, bodyH);
    }

    //    修改
    function edit() {
        if($('#tb_departments').bootstrapTable('getSelections').length == 1){
            layerOpenFn('${showPagePath}','编辑动物医院', 'base/epidemic/epidemic_epidemic_preventionEditPage', bodyW-100, bodyH);
        }else {
    ...
    //    删除
    function deleteFun() {
        sysDeleteFun('EpidemicZooHospitalMapper.deleteInfo');
    }

    //    导出
    $('#btn_export').click(function () {
        var mmm = ['医院名称','备注','状态','联系电话','','医院地址','联系人',''];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=EpidemicZooHospitalMapper.selectInfo&fileName=动物医院管理&titleParams='+titleParams);
    });
</script>
