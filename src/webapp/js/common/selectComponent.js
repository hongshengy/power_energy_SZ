...
gdc.component.select.MultiSelect = Ext.extend(gdc.component.select.SingleSelect, {
    //id: this.name+'select',
    tpl: '<div><input type=button id=ok value="确定" onclick=gdc.component.select.obj.collapse()><input type=button id=all value="全部" onclick=gdc.component.select.obj.selectAll()><input type=button id=none value="清空" onclick=gdc.component.select.obj.clearAll()></div><div class="multiselect"></div>',
