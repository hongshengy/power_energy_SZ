...
<div class="panel-body" style="padding:5px;">
    <div class="panel panel-default">
        <div class="panel-heading">退役犬自养管理</div>
...
<script type="text/javascript">
    ...
    var pageDataSql = 'RetireAutotrophicMapper.getListByParamsByPage';
    ...
    var columns = [
        {
            ...
            field: 'autotrophic_admin',
            title: '领养管理员'
        }, {
            field: 'autotrophic_address',
            title: '领养地址'
        }, {
            field: 'report',
            title: '非正常情况报告 '
...
//    添加
    function add() {
        layerOpenFn('${showPagePath}','添加退役犬自养','base/retire/retire_autotrophicPage',bodyW-100, bodyH);
    }

    //    修改
    function edit() {
        if($('#tb_departments').bootstrapTable('getSelections').length == 1){
            layerOpenFn('${showPagePath}','编辑退役犬自养', 'base/retire/retire_autotrophicEditPage', bodyW-100, bodyH);
        }else {
    ...
    //    删除
    function deleteFun() {
        sysDeleteFun('RetireAutotrophicMapper.deleteInfo');
    }

    //    导出
    $('#btn_export').click(function () {
        var mmm = ['领养管理员','处置','领养地址','非正常情况报告','领养时间','ID','检疫犬ID'];
        var titleParams = mmm.join(",");
        window.open('${exportPath}'+$('#formSearch').serialize()+'&sql=RetireAutotrophicMapper.selectInfo&fileName=退役犬自养管理&titleParams='+titleParams);
    });
</script>
