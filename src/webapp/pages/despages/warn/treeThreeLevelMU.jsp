	...
	<body>
		...
		<div id='view3' style="width: 100%;" >
			<div id="cxTab" class="easyui-tabs" style="width:100%;">   
			    <div title="电压曲线" style="display:none;"> 
			    	<div id="view4">  
			        	<iframe id="Frame5" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>
			        </div>
			    </div> 
			    <div title="母排温度曲线" style="display:none;">  
			    	<div id="view5">   
			        	<iframe id="Frame6" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>
			        </div>
			    </div> 
			     <div title="测点实时数据" style="display:none;">   
			    	<div id="view6">   
			        	<iframe id="Frame7" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>
			        </div> 
			    </div> 
			</div> 
		</div>
        	 ...
        	 $('#cxTab').tabs({    
			    ...
			    onSelect:function(title,index){  
			        ...
			        if(index == 0){
			        	...
			        	document.getElementById("Frame7").src = basePath+"pages/areaEnergy/consDataCentre/xlcdsssjTAB.jsp?bsId="+lineId+"&mpType="+mpType+"&riqiIn="+searchrq+"&hheight="+mainHeight;
			        }
			    }    
		  }); 
		  //默认显示 
