...
<script type="text/javascript" src="<%=request.getContextPath() %>/pages/despages/common/echarts/echarts.min.js"></script>
		<script type="text/javascript">
			 var lineId = '${param.LINE_ID}';
			 var dateTime = '${param.START_DAY}';
			 var dateTime1 = '${param.END_DAY}';
			 var dateType = '${param.DATA_TYPE}';
		</script>
...
<script type="text/javascript">
		...
		function loadEchartPageByLine(){
			...
			var option = {
			    title : {
			        text: '日电量  数据日期('+dateTime+'~'+dateTime1+')',
			        subtext: '',
			        x: 'center'
			    },
			    tooltip : {
		...
		function loadData(){
			var queryparam = "queryPara.LINE_ID="+lineId+"&queryPara.START_DAY="+dateTime+"&queryPara.QUERY_TYPE=02&queryPara.ORG_NO=01&queryPara.QUERYSIZE=24&queryPara.END_DAY="+dateTime1+"&queryPara.DATA_TYPE="+dateType;
			$.ajax({
				type: "post",
				url: "<%=basePath%>/userDataCenterAction/loadyhfbLineDayHourBar.action",
				data : queryparam,
				dataType : "json",
				cache : false,
				async : false,//同步异步请求
				success : function(result) {
					xNameLineName = result.X_DATA_TIME;
					xNameLineTime = result.X_DATA_INFO1;
					xNameLineTime1 = result.X_DATA_INFO2;
					xNameLineTime2 = result.X_DATA_INFO3;
					xNameLineTime3 = result.X_DATA_INFO4;
					xNameLineTime4 = result.X_DATA_INFO0;
